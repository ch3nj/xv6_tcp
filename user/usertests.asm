...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
       ...
       4:	b3078793          	addi	a5,a5,-1232 # 6b30 <uninit>
       8:	00009697          	auipc	a3,0x9
       c:	23868693          	addi	a3,a3,568 # 9240 <buf>
    if(uninit[i] != '\0'){
      ...
      1c:	8082                	ret
{
      ...
      2c:	bb850513          	addi	a0,a0,-1096 # 4be0 <malloc+0x372>
      30:	00004097          	auipc	ra,0x4
      34:	780080e7          	jalr	1920(ra) # 47b0 <printf>
      exit(1);
      38:	4505                	li	a0,1
...
0000000000000042 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    printf("%s: mkdir failed\n", s);
      ...
      ae:	b5650513          	addi	a0,a0,-1194 # 4c00 <malloc+0x392>
      b2:	00004097          	auipc	ra,0x4
      b6:	6fe080e7          	jalr	1790(ra) # 47b0 <printf>
    exit(1);
      ba:	4505                	li	a0,1
    ...
    printf("%s: chdir iputdir failed\n", s);
      ...
      ca:	b5250513          	addi	a0,a0,-1198 # 4c18 <malloc+0x3aa>
      ce:	00004097          	auipc	ra,0x4
      d2:	6e2080e7          	jalr	1762(ra) # 47b0 <printf>
    exit(1);
      d6:	4505                	li	a0,1
    ...
    printf("%s: unlink ../iputdir failed\n", s);
      ...
      e6:	b6650513          	addi	a0,a0,-1178 # 4c48 <malloc+0x3da>
      ea:	00004097          	auipc	ra,0x4
      ee:	6c6080e7          	jalr	1734(ra) # 47b0 <printf>
    exit(1);
      f2:	4505                	li	a0,1
    ...
    printf("%s: chdir / failed\n", s);
     ...
     102:	b7250513          	addi	a0,a0,-1166 # 4c70 <malloc+0x402>
     106:	00004097          	auipc	ra,0x4
     10a:	6aa080e7          	jalr	1706(ra) # 47b0 <printf>
    exit(1);
     10e:	4505                	li	a0,1
...
0000000000000118 <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    printf("%s: mkdir dots failed\n", s);
     ...
     1c4:	ad050513          	addi	a0,a0,-1328 # 4c90 <malloc+0x422>
     1c8:	00004097          	auipc	ra,0x4
     1cc:	5e8080e7          	jalr	1512(ra) # 47b0 <printf>
    exit(1);
     1d0:	4505                	li	a0,1
    ...
    printf("%s: chdir dots failed\n", s);
     ...
     1e0:	acc50513          	addi	a0,a0,-1332 # 4ca8 <malloc+0x43a>
     1e4:	00004097          	auipc	ra,0x4
     1e8:	5cc080e7          	jalr	1484(ra) # 47b0 <printf>
    exit(1);
     1ec:	4505                	li	a0,1
    ...
    printf("%s: rm . worked!\n", s);
     ...
     1fc:	ad050513          	addi	a0,a0,-1328 # 4cc8 <malloc+0x45a>
     200:	00004097          	auipc	ra,0x4
     204:	5b0080e7          	jalr	1456(ra) # 47b0 <printf>
    exit(1);
     208:	4505                	li	a0,1
    ...
    printf("%s: rm .. worked!\n", s);
     ...
     218:	ad450513          	addi	a0,a0,-1324 # 4ce8 <malloc+0x47a>
     21c:	00004097          	auipc	ra,0x4
     220:	594080e7          	jalr	1428(ra) # 47b0 <printf>
    exit(1);
     224:	4505                	li	a0,1
    ...
    printf("%s: chdir / failed\n", s);
     ...
     234:	a4050513          	addi	a0,a0,-1472 # 4c70 <malloc+0x402>
     238:	00004097          	auipc	ra,0x4
     23c:	578080e7          	jalr	1400(ra) # 47b0 <printf>
    exit(1);
     240:	4505                	li	a0,1
    ...
    printf("%s: unlink dots/. worked!\n", s);
     ...
     250:	abc50513          	addi	a0,a0,-1348 # 4d08 <malloc+0x49a>
     254:	00004097          	auipc	ra,0x4
     258:	55c080e7          	jalr	1372(ra) # 47b0 <printf>
    exit(1);
     25c:	4505                	li	a0,1
    ...
    printf("%s: unlink dots/.. worked!\n", s);
     ...
     26c:	ac850513          	addi	a0,a0,-1336 # 4d30 <malloc+0x4c2>
     270:	00004097          	auipc	ra,0x4
     274:	540080e7          	jalr	1344(ra) # 47b0 <printf>
    exit(1);
     278:	4505                	li	a0,1
    ...
    printf("%s: unlink dots failed!\n", s);
     ...
     288:	acc50513          	addi	a0,a0,-1332 # 4d50 <malloc+0x4e2>
     28c:	00004097          	auipc	ra,0x4
     290:	524080e7          	jalr	1316(ra) # 47b0 <printf>
    exit(1);
     294:	4505                	li	a0,1
...
000000000000029e <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     2bc:	94050513          	addi	a0,a0,-1728 # 4bf8 <malloc+0x38a>
    ...
    if(chdir("iputdir") < 0){
     ...
     2d0:	92c50513          	addi	a0,a0,-1748 # 4bf8 <malloc+0x38a>
    ...
    if(unlink("../iputdir") < 0){
     ...
     2e4:	95850513          	addi	a0,a0,-1704 # 4c38 <malloc+0x3ca>
    ...
    printf("%s: fork failed\n", s);
     ...
     304:	a7050513          	addi	a0,a0,-1424 # 4d70 <malloc+0x502>
     308:	00004097          	auipc	ra,0x4
     30c:	4a8080e7          	jalr	1192(ra) # 47b0 <printf>
    exit(1);
     310:	4505                	li	a0,1
     ...
     320:	8e450513          	addi	a0,a0,-1820 # 4c00 <malloc+0x392>
     324:	00004097          	auipc	ra,0x4
     328:	48c080e7          	jalr	1164(ra) # 47b0 <printf>
      exit(1);
     32c:	4505                	li	a0,1
     ...
     33c:	a5050513          	addi	a0,a0,-1456 # 4d88 <malloc+0x51a>
     340:	00004097          	auipc	ra,0x4
     344:	470080e7          	jalr	1136(ra) # 47b0 <printf>
      exit(1);
     348:	4505                	li	a0,1
     ...
     358:	8f450513          	addi	a0,a0,-1804 # 4c48 <malloc+0x3da>
     35c:	00004097          	auipc	ra,0x4
     360:	454080e7          	jalr	1108(ra) # 47b0 <printf>
      exit(1);
     364:	4505                	li	a0,1
...
0000000000000386 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
     ...
     3e2:	99250513          	addi	a0,a0,-1646 # 4d70 <malloc+0x502>
     3e6:	00004097          	auipc	ra,0x4
     3ea:	3ca080e7          	jalr	970(ra) # 47b0 <printf>
      exit(1);
     3ee:	4505                	li	a0,1
     ...
     3fe:	9a650513          	addi	a0,a0,-1626 # 4da0 <malloc+0x532>
     402:	00004097          	auipc	ra,0x4
     406:	3ae080e7          	jalr	942(ra) # 47b0 <printf>
        exit(1);
     40a:	4505                	li	a0,1
     ...
     41a:	9a250513          	addi	a0,a0,-1630 # 4db8 <malloc+0x54a>
     41e:	00004097          	auipc	ra,0x4
     422:	392080e7          	jalr	914(ra) # 47b0 <printf>
        exit(1);
     426:	4505                	li	a0,1
...
000000000000043a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
     ...
     492:	8e250513          	addi	a0,a0,-1822 # 4d70 <malloc+0x502>
     496:	00004097          	auipc	ra,0x4
     49a:	31a080e7          	jalr	794(ra) # 47b0 <printf>
      exit(1);
     49e:	4505                	li	a0,1
     ...
     4b6:	8be50513          	addi	a0,a0,-1858 # 4d70 <malloc+0x502>
     4ba:	00004097          	auipc	ra,0x4
     4be:	2f6080e7          	jalr	758(ra) # 47b0 <printf>
        exit(1);
     4c2:	4505                	li	a0,1
...
00000000000004d4 <forkfork>:
{
    ...
    if(xstatus != 0) {
     ...
     530:	8ac50513          	addi	a0,a0,-1876 # 4dd8 <malloc+0x56a>
     534:	00004097          	auipc	ra,0x4
     538:	27c080e7          	jalr	636(ra) # 47b0 <printf>
      exit(1);
     53c:	4505                	li	a0,1
     ...
     542:	eea080e7          	jalr	-278(ra) # 4428 <exit>
{
     ...
     588:	86450513          	addi	a0,a0,-1948 # 4de8 <malloc+0x57a>
     58c:	00004097          	auipc	ra,0x4
     590:	224080e7          	jalr	548(ra) # 47b0 <printf>
      exit(1);
     594:	4505                	li	a0,1
...
000000000000059e <reparent2>:
{
  ...
  exit(0);
     ...
     5d6:	09e50513          	addi	a0,a0,158 # 5670 <malloc+0xe02>
     5da:	00004097          	auipc	ra,0x4
     5de:	1d6080e7          	jalr	470(ra) # 47b0 <printf>
      exit(1);
     5e2:	4505                	li	a0,1
...
0000000000000606 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    printf("%s: fork claimed to work 1000 times!\n", s);
     ...
     636:	7ee50513          	addi	a0,a0,2030 # 4e20 <malloc+0x5b2>
     63a:	00004097          	auipc	ra,0x4
     63e:	176080e7          	jalr	374(ra) # 47b0 <printf>
    exit(1);
     642:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    printf("%s: no fork at all!\n", s);
     ...
     698:	77450513          	addi	a0,a0,1908 # 4e08 <malloc+0x59a>
     69c:	00004097          	auipc	ra,0x4
     6a0:	114080e7          	jalr	276(ra) # 47b0 <printf>
    exit(1);
     6a4:	4505                	li	a0,1
     ...
     6b4:	79850513          	addi	a0,a0,1944 # 4e48 <malloc+0x5da>
     6b8:	00004097          	auipc	ra,0x4
     6bc:	0f8080e7          	jalr	248(ra) # 47b0 <printf>
      exit(1);
     6c0:	4505                	li	a0,1
    ...
    printf("%s: wait got too many\n", s);
     ...
     6d0:	79450513          	addi	a0,a0,1940 # 4e60 <malloc+0x5f2>
     6d4:	00004097          	auipc	ra,0x4
     6d8:	0dc080e7          	jalr	220(ra) # 47b0 <printf>
    exit(1);
     6dc:	4505                	li	a0,1
...
00000000000006e6 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
     700:	69b1                	lui	s3,0xc
     702:	35098993          	addi	s3,s3,848 # c350 <__BSS_END__+0x100>
     706:	1003d937          	lui	s2,0x1003d
     70a:	090e                	slli	s2,s2,0x3
     70c:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x10031230>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
     ...
     750:	62450513          	addi	a0,a0,1572 # 4d70 <malloc+0x502>
     754:	00004097          	auipc	ra,0x4
     758:	05c080e7          	jalr	92(ra) # 47b0 <printf>
      exit(1);
     75c:	4505                	li	a0,1
     ...
     770:	70c50513          	addi	a0,a0,1804 # 4e78 <malloc+0x60a>
     774:	00004097          	auipc	ra,0x4
     778:	03c080e7          	jalr	60(ra) # 47b0 <printf>
      exit(1);
     77c:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    printf("%s: stacktest: read below stack %p\n", *sp);
     ...
     7ce:	0007c583          	lbu	a1,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff2db0>
     7d2:	00004517          	auipc	a0,0x4
     7d6:	6c650513          	addi	a0,a0,1734 # 4e98 <malloc+0x62a>
     7da:	00004097          	auipc	ra,0x4
     7de:	fd6080e7          	jalr	-42(ra) # 47b0 <printf>
    exit(1);
     7e2:	4505                	li	a0,1
    ...
    printf("%s: fork failed\n", s);
     ...
     7f2:	58250513          	addi	a0,a0,1410 # 4d70 <malloc+0x502>
     7f6:	00004097          	auipc	ra,0x4
     7fa:	fba080e7          	jalr	-70(ra) # 47b0 <printf>
    exit(1);
     7fe:	4505                	li	a0,1
...
0000000000000812 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
     ...
     822:	6a250513          	addi	a0,a0,1698 # 4ec0 <malloc+0x652>
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     846:	67e50513          	addi	a0,a0,1662 # 4ec0 <malloc+0x652>
    ...
    if(fd >= 0){
     ...
     85c:	68850513          	addi	a0,a0,1672 # 4ee0 <malloc+0x672>
     860:	00004097          	auipc	ra,0x4
     864:	f50080e7          	jalr	-176(ra) # 47b0 <printf>
      exit(1);
     868:	4505                	li	a0,1
    ...
    printf("%s: mkdir oidir failed\n", s);
     ...
     878:	65450513          	addi	a0,a0,1620 # 4ec8 <malloc+0x65a>
     87c:	00004097          	auipc	ra,0x4
     880:	f34080e7          	jalr	-204(ra) # 47b0 <printf>
    exit(1);
     884:	4505                	li	a0,1
    ...
    printf("%s: fork failed\n", s);
     ...
     894:	4e050513          	addi	a0,a0,1248 # 4d70 <malloc+0x502>
     898:	00004097          	auipc	ra,0x4
     89c:	f18080e7          	jalr	-232(ra) # 47b0 <printf>
    exit(1);
     8a0:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
     ...
     8c2:	60250513          	addi	a0,a0,1538 # 4ec0 <malloc+0x652>
    ...
    printf("%s: unlink failed\n", s);
     ...
     8d6:	63650513          	addi	a0,a0,1590 # 4f08 <malloc+0x69a>
     8da:	00004097          	auipc	ra,0x4
     8de:	ed6080e7          	jalr	-298(ra) # 47b0 <printf>
    exit(1);
     8e2:	4505                	li	a0,1
...
0000000000000904 <opentest>:
{
  ...
  fd = open("echo", 0);
     ...
     916:	60e50513          	addi	a0,a0,1550 # 4f20 <malloc+0x6b2>
  ...
  fd = open("doesnotexist", 0);
     ...
     934:	61050513          	addi	a0,a0,1552 # 4f40 <malloc+0x6d2>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
     ...
     954:	5d850513          	addi	a0,a0,1496 # 4f28 <malloc+0x6ba>
     958:	00004097          	auipc	ra,0x4
     95c:	e58080e7          	jalr	-424(ra) # 47b0 <printf>
    exit(1);
     960:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     970:	5e450513          	addi	a0,a0,1508 # 4f50 <malloc+0x6e2>
     974:	00004097          	auipc	ra,0x4
     978:	e3c080e7          	jalr	-452(ra) # 47b0 <printf>
    exit(1);
     97c:	4505                	li	a0,1
...
0000000000000986 <createtest>:
{
  ...
  name[0] = 'a';
     ...
     998:	08c78793          	addi	a5,a5,140 # 6a20 <_edata>
  ...
  name[0] = 'a';
     ...
     9da:	04a78793          	addi	a5,a5,74 # 6a20 <_edata>
...
0000000000000a1a <forkforkfork>:
{
  ...
  unlink("stopforking");
     ...
     a2a:	55250513          	addi	a0,a0,1362 # 4f78 <malloc+0x70a>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
     ...
     a56:	52650513          	addi	a0,a0,1318 # 4f78 <malloc+0x70a>
  ...
  sleep(10); // one second
    ...
    printf("%s: fork failed", s);
     ...
     a8e:	34e50513          	addi	a0,a0,846 # 4dd8 <malloc+0x56a>
     a92:	00004097          	auipc	ra,0x4
     a96:	d1e080e7          	jalr	-738(ra) # 47b0 <printf>
    exit(1);
     a9a:	4505                	li	a0,1
     ...
     aa8:	4d448493          	addi	s1,s1,1236 # 4f78 <malloc+0x70a>
     aac:	4581                	li	a1,0
     aae:	8526                	mv	a0,s1
...
0000000000000aea <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    for(pi = 0; pi < NCHILD; pi++){
     ...
     b58:	b1c50513          	addi	a0,a0,-1252 # 5670 <malloc+0xe02>
     b5c:	00004097          	auipc	ra,0x4
     b60:	c54080e7          	jalr	-940(ra) # 47b0 <printf>
      exit(1);
     b64:	4505                	li	a0,1
     ...
     b84:	40850513          	addi	a0,a0,1032 # 4f88 <malloc+0x71a>
     b88:	00004097          	auipc	ra,0x4
     b8c:	c28080e7          	jalr	-984(ra) # 47b0 <printf>
          exit(1);
     b90:	4505                	li	a0,1
     ...
     bf6:	31650513          	addi	a0,a0,790 # 4f08 <malloc+0x69a>
     bfa:	00004097          	auipc	ra,0x4
     bfe:	bb6080e7          	jalr	-1098(ra) # 47b0 <printf>
            exit(1);
     c02:	4505                	li	a0,1
     ...
     c2a:	37a50513          	addi	a0,a0,890 # 4fa0 <malloc+0x732>
     c2e:	00004097          	auipc	ra,0x4
     c32:	b82080e7          	jalr	-1150(ra) # 47b0 <printf>
        exit(1);
     c36:	4505                	li	a0,1
    ...
    for(pi = 0; pi < NCHILD; pi++){
     ...
     c90:	33c50513          	addi	a0,a0,828 # 4fc8 <malloc+0x75a>
     c94:	00004097          	auipc	ra,0x4
     c98:	b1c080e7          	jalr	-1252(ra) # 47b0 <printf>
        exit(1);
     c9c:	4505                	li	a0,1
...
0000000000000d10 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
     ...
     d20:	4a450513          	addi	a0,a0,1188 # 51c0 <malloc+0x952>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
     ...
     d32:	2ea50513          	addi	a0,a0,746 # 5018 <malloc+0x7aa>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
     ...
     d48:	32c50513          	addi	a0,a0,812 # 5070 <malloc+0x802>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
     ...
     d66:	38650513          	addi	a0,a0,902 # 50e8 <malloc+0x87a>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
     ...
     d82:	3da50513          	addi	a0,a0,986 # 5158 <malloc+0x8ea>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
     ...
     d94:	42050513          	addi	a0,a0,1056 # 51b0 <malloc+0x942>
    ...
    printf("%s: mkdir 12345678901234 failed\n", s);
     ...
     db2:	24250513          	addi	a0,a0,578 # 4ff0 <malloc+0x782>
     db6:	00004097          	auipc	ra,0x4
     dba:	9fa080e7          	jalr	-1542(ra) # 47b0 <printf>
    exit(1);
     dbe:	4505                	li	a0,1
    ...
    printf("%s: mkdir 12345678901234/123456789012345 failed\n", s);
     ...
     dce:	26e50513          	addi	a0,a0,622 # 5038 <malloc+0x7ca>
     dd2:	00004097          	auipc	ra,0x4
     dd6:	9de080e7          	jalr	-1570(ra) # 47b0 <printf>
    exit(1);
     dda:	4505                	li	a0,1
    ...
    printf("%s: create 123456789012345/123456789012345/123456789012345 failed\n", s);
     ...
     dea:	2ba50513          	addi	a0,a0,698 # 50a0 <malloc+0x832>
     dee:	00004097          	auipc	ra,0x4
     df2:	9c2080e7          	jalr	-1598(ra) # 47b0 <printf>
    exit(1);
     df6:	4505                	li	a0,1
    ...
    printf("%s: open 12345678901234/12345678901234/12345678901234 failed\n", s);
     ...
     e06:	31650513          	addi	a0,a0,790 # 5118 <malloc+0x8aa>
     e0a:	00004097          	auipc	ra,0x4
     e0e:	9a6080e7          	jalr	-1626(ra) # 47b0 <printf>
    exit(1);
     e12:	4505                	li	a0,1
    ...
    printf("%s: mkdir 12345678901234/12345678901234 succeeded!\n", s);
     ...
     e22:	35a50513          	addi	a0,a0,858 # 5178 <malloc+0x90a>
     e26:	00004097          	auipc	ra,0x4
     e2a:	98a080e7          	jalr	-1654(ra) # 47b0 <printf>
    exit(1);
     e2e:	4505                	li	a0,1
    ...
    printf("%s: mkdir 12345678901234/123456789012345 succeeded!\n", s);
     ...
     e3e:	39650513          	addi	a0,a0,918 # 51d0 <malloc+0x962>
     e42:	00004097          	auipc	ra,0x4
     e46:	96e080e7          	jalr	-1682(ra) # 47b0 <printf>
    exit(1);
     e4a:	4505                	li	a0,1
...
0000000000000e54 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     e70:	c2450513          	addi	a0,a0,-988 # 4a90 <malloc+0x222>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     e84:	c10a8a93          	addi	s5,s5,-1008 # 4a90 <malloc+0x222>
      int cc = write(fd, buf, sz);
     e88:	00008a17          	auipc	s4,0x8
     e8c:	3b8a0a13          	addi	s4,s4,952 # 9240 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     e90:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     f06:	30650513          	addi	a0,a0,774 # 5208 <malloc+0x99a>
     f0a:	00004097          	auipc	ra,0x4
     f0e:	8a6080e7          	jalr	-1882(ra) # 47b0 <printf>
      exit(1);
     f12:	4505                	li	a0,1
     ...
     f2a:	30250513          	addi	a0,a0,770 # 5228 <malloc+0x9ba>
     f2e:	00004097          	auipc	ra,0x4
     f32:	882080e7          	jalr	-1918(ra) # 47b0 <printf>
        exit(1);
     f36:	4505                	li	a0,1
...
0000000000000f40 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     f5e:	2e650513          	addi	a0,a0,742 # 5240 <malloc+0x9d2>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     f76:	2f698993          	addi	s3,s3,758 # 5268 <malloc+0x9fa>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     f7a:	00004a97          	auipc	s5,0x4
     f7e:	326a8a93          	addi	s5,s5,806 # 52a0 <malloc+0xa32>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     fc4:	28050513          	addi	a0,a0,640 # 5240 <malloc+0x9d2>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     fde:	26658593          	addi	a1,a1,614 # 9240 <buf>
  ...
  if(unlink("small") < 0){
    ...
    1000:	24450513          	addi	a0,a0,580 # 5240 <malloc+0x9d2>
    ...
    102a:	22250513          	addi	a0,a0,546 # 5248 <malloc+0x9da>
    102e:	00003097          	auipc	ra,0x3
    1032:	782080e7          	jalr	1922(ra) # 47b0 <printf>
    exit(1);
    1036:	4505                	li	a0,1
    ...
    1046:	23650513          	addi	a0,a0,566 # 5278 <malloc+0xa0a>
    104a:	00003097          	auipc	ra,0x3
    104e:	766080e7          	jalr	1894(ra) # 47b0 <printf>
      exit(1);
    1052:	4505                	li	a0,1
    ...
    1062:	25250513          	addi	a0,a0,594 # 52b0 <malloc+0xa42>
    1066:	00003097          	auipc	ra,0x3
    106a:	74a080e7          	jalr	1866(ra) # 47b0 <printf>
      exit(1);
    106e:	4505                	li	a0,1
    ...
    107e:	25e50513          	addi	a0,a0,606 # 52d8 <malloc+0xa6a>
    1082:	00003097          	auipc	ra,0x3
    1086:	72e080e7          	jalr	1838(ra) # 47b0 <printf>
    exit(1);
    108a:	4505                	li	a0,1
    ...
    109a:	26250513          	addi	a0,a0,610 # 52f8 <malloc+0xa8a>
    109e:	00003097          	auipc	ra,0x3
    10a2:	712080e7          	jalr	1810(ra) # 47b0 <printf>
    exit(1);
    10a6:	4505                	li	a0,1
    ...
    10b6:	25e50513          	addi	a0,a0,606 # 5310 <malloc+0xaa2>
    10ba:	00003097          	auipc	ra,0x3
    10be:	6f6080e7          	jalr	1782(ra) # 47b0 <printf>
    exit(1);
    10c2:	4505                	li	a0,1
...
00000000000010cc <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    10e8:	24c50513          	addi	a0,a0,588 # 5330 <malloc+0xac2>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    10fc:	14890913          	addi	s2,s2,328 # 9240 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
    ...
    113a:	1fa50513          	addi	a0,a0,506 # 5330 <malloc+0xac2>
  ...
  n = 0;
    ...
    114e:	0f690913          	addi	s2,s2,246 # 9240 <buf>
  if(fd < 0){
    ...
    1182:	1ba50513          	addi	a0,a0,442 # 5338 <malloc+0xaca>
    1186:	00003097          	auipc	ra,0x3
    118a:	62a080e7          	jalr	1578(ra) # 47b0 <printf>
    exit(1);
    118e:	4505                	li	a0,1
    ...
    119e:	1be50513          	addi	a0,a0,446 # 5358 <malloc+0xaea>
    11a2:	00003097          	auipc	ra,0x3
    11a6:	60e080e7          	jalr	1550(ra) # 47b0 <printf>
      exit(1);
    11aa:	4505                	li	a0,1
    ...
    11ba:	1ca50513          	addi	a0,a0,458 # 5380 <malloc+0xb12>
    11be:	00003097          	auipc	ra,0x3
    11c2:	5f2080e7          	jalr	1522(ra) # 47b0 <printf>
    exit(1);
    11c6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
    ...
    11e6:	14e50513          	addi	a0,a0,334 # 5330 <malloc+0xac2>
    ...
    1210:	19450513          	addi	a0,a0,404 # 53a0 <malloc+0xb32>
    1214:	00003097          	auipc	ra,0x3
    1218:	59c080e7          	jalr	1436(ra) # 47b0 <printf>
        exit(1);
    121c:	4505                	li	a0,1
    ...
    122c:	1a050513          	addi	a0,a0,416 # 53c8 <malloc+0xb5a>
    1230:	00003097          	auipc	ra,0x3
    1234:	580080e7          	jalr	1408(ra) # 47b0 <printf>
      exit(1);
    1238:	4505                	li	a0,1
    ...
    1248:	19c50513          	addi	a0,a0,412 # 53e0 <malloc+0xb72>
    124c:	00003097          	auipc	ra,0x3
    1250:	564080e7          	jalr	1380(ra) # 47b0 <printf>
      exit(1);
    1254:	4505                	li	a0,1
    ...
    1264:	1a850513          	addi	a0,a0,424 # 5408 <malloc+0xb9a>
    1268:	00003097          	auipc	ra,0x3
    126c:	548080e7          	jalr	1352(ra) # 47b0 <printf>
    exit(1);
    1270:	4505                	li	a0,1
...
000000000000127a <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1292:	79a50513          	addi	a0,a0,1946 # 4a28 <malloc+0x1ba>
  ...
  write(fd, "hello", SZ);
    ...
    12aa:	19a58593          	addi	a1,a1,410 # 5440 <malloc+0xbd2>
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12c6:	76650513          	addi	a0,a0,1894 # 4a28 <malloc+0x1ba>
  ...
  if(unlink("unlinkread") != 0){
    ...
    12dc:	75050513          	addi	a0,a0,1872 # 4a28 <malloc+0x1ba>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    12f2:	73a50513          	addi	a0,a0,1850 # 4a28 <malloc+0x1ba>
  ...
  write(fd1, "yyy", 3);
    ...
    1306:	18658593          	addi	a1,a1,390 # 5488 <malloc+0xc1a>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    1322:	f2258593          	addi	a1,a1,-222 # 9240 <buf>
    1326:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
    ...
    136e:	6be50513          	addi	a0,a0,1726 # 4a28 <malloc+0x1ba>
    ...
    138e:	09650513          	addi	a0,a0,150 # 5420 <malloc+0xbb2>
    1392:	00003097          	auipc	ra,0x3
    1396:	41e080e7          	jalr	1054(ra) # 47b0 <printf>
    exit(1);
    139a:	4505                	li	a0,1
    ...
    13aa:	0a250513          	addi	a0,a0,162 # 5448 <malloc+0xbda>
    13ae:	00003097          	auipc	ra,0x3
    13b2:	402080e7          	jalr	1026(ra) # 47b0 <printf>
    exit(1);
    13b6:	4505                	li	a0,1
    ...
    13c6:	0a650513          	addi	a0,a0,166 # 5468 <malloc+0xbfa>
    13ca:	00003097          	auipc	ra,0x3
    13ce:	3e6080e7          	jalr	998(ra) # 47b0 <printf>
    exit(1);
    13d2:	4505                	li	a0,1
    ...
    13e2:	0b250513          	addi	a0,a0,178 # 5490 <malloc+0xc22>
    13e6:	00003097          	auipc	ra,0x3
    13ea:	3ca080e7          	jalr	970(ra) # 47b0 <printf>
    exit(1);
    13ee:	4505                	li	a0,1
    ...
    13fe:	0b650513          	addi	a0,a0,182 # 54b0 <malloc+0xc42>
    1402:	00003097          	auipc	ra,0x3
    1406:	3ae080e7          	jalr	942(ra) # 47b0 <printf>
    exit(1);
    140a:	4505                	li	a0,1
    ...
    141a:	0ba50513          	addi	a0,a0,186 # 54d0 <malloc+0xc62>
    141e:	00003097          	auipc	ra,0x3
    1422:	392080e7          	jalr	914(ra) # 47b0 <printf>
    exit(1);
    1426:	4505                	li	a0,1
...
0000000000001430 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1442:	ae278793          	addi	a5,a5,-1310 # 4f20 <malloc+0x6b2>
    1446:	fcf43023          	sd	a5,-64(s0)
    144a:	00004797          	auipc	a5,0x4
    144e:	0a678793          	addi	a5,a5,166 # 54f0 <malloc+0xc82>
    1452:	fcf43423          	sd	a5,-56(s0)
    1456:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    145a:	00004517          	auipc	a0,0x4
    145e:	09e50513          	addi	a0,a0,158 # 54f8 <malloc+0xc8a>
  ...
  if(pid == 0) {
    ...
    148c:	07050513          	addi	a0,a0,112 # 54f8 <malloc+0xc8a>
    ...
    14a8:	05c50513          	addi	a0,a0,92 # 5500 <malloc+0xc92>
    14ac:	00003097          	auipc	ra,0x3
    14b0:	304080e7          	jalr	772(ra) # 47b0 <printf>
      exit(1);
    14b4:	4505                	li	a0,1
    ...
    14c4:	8b050513          	addi	a0,a0,-1872 # 4d70 <malloc+0x502>
    14c8:	00003097          	auipc	ra,0x3
    14cc:	2e8080e7          	jalr	744(ra) # 47b0 <printf>
     exit(1);
    14d0:	4505                	li	a0,1
    ...
    14e0:	aac50513          	addi	a0,a0,-1364 # 4f88 <malloc+0x71a>
    14e4:	00003097          	auipc	ra,0x3
    14e8:	2cc080e7          	jalr	716(ra) # 47b0 <printf>
      exit(1);
    14ec:	4505                	li	a0,1
    ...
    14fe:	a2650513          	addi	a0,a0,-1498 # 4f20 <malloc+0x6b2>
  ...
  if(xstatus != 0)
    ...
    1532:	fe250513          	addi	a0,a0,-30 # 5510 <malloc+0xca2>
    1536:	00003097          	auipc	ra,0x3
    153a:	27a080e7          	jalr	634(ra) # 47b0 <printf>
      exit(1);
    153e:	4505                	li	a0,1
    ...
    154e:	fde50513          	addi	a0,a0,-34 # 5528 <malloc+0xcba>
    1552:	00003097          	auipc	ra,0x3
    1556:	25e080e7          	jalr	606(ra) # 47b0 <printf>
    155a:	b7d1                	j	151e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    155c:	4581                	li	a1,0
    155e:	00004517          	auipc	a0,0x4
    1562:	f9a50513          	addi	a0,a0,-102 # 54f8 <malloc+0xc8a>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    158c:	d7050513          	addi	a0,a0,-656 # 52f8 <malloc+0xa8a>
    1590:	00003097          	auipc	ra,0x3
    1594:	220080e7          	jalr	544(ra) # 47b0 <printf>
    exit(1);
    1598:	4505                	li	a0,1
    ...
    15a8:	f9c50513          	addi	a0,a0,-100 # 5540 <malloc+0xcd2>
    15ac:	00003097          	auipc	ra,0x3
    15b0:	204080e7          	jalr	516(ra) # 47b0 <printf>
    exit(1);
    15b4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    15c2:	f3a50513          	addi	a0,a0,-198 # 54f8 <malloc+0xc8a>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    15ec:	f7050513          	addi	a0,a0,-144 # 5558 <malloc+0xcea>
    15f0:	00003097          	auipc	ra,0x3
    15f4:	1c0080e7          	jalr	448(ra) # 47b0 <printf>
    exit(1);
    15f8:	4505                	li	a0,1
...
000000000000160c <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    161c:	f5850513          	addi	a0,a0,-168 # 5570 <malloc+0xd02>
  ...
  fd = open("bigarg-ok", 0);
    ...
    164e:	f2650513          	addi	a0,a0,-218 # 5570 <malloc+0xd02>
  ...
  close(fd);
    ...
    1674:	3c078793          	addi	a5,a5,960 # 6a30 <args.1711>
    1678:	00005697          	auipc	a3,0x5
    167c:	4b068693          	addi	a3,a3,1200 # 6b28 <args.1711+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    1680:	00004717          	auipc	a4,0x4
    1684:	f0070713          	addi	a4,a4,-256 # 5580 <malloc+0xd12>
    ...
    16d8:	f8c50513          	addi	a0,a0,-116 # 5660 <malloc+0xdf2>
    16dc:	00003097          	auipc	ra,0x3
    16e0:	0d4080e7          	jalr	212(ra) # 47b0 <printf>
    exit(1);
    16e4:	4505                	li	a0,1
    ...
    16fc:	f8850513          	addi	a0,a0,-120 # 5680 <malloc+0xe12>
    1700:	00003097          	auipc	ra,0x3
    1704:	0b0080e7          	jalr	176(ra) # 47b0 <printf>
    exit(1);
    1708:	4505                	li	a0,1
...
badarg(char *s)
{
    ...
    1722:	35048493          	addi	s1,s1,848 # c350 <__BSS_END__+0x100>
  for(int i = 0; i < 50000; i++){
    ...
    1730:	7f498993          	addi	s3,s3,2036 # 4f20 <malloc+0x6b2>
    argv[0] = (char*)0xffffffff;
...
0000000000001758 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17a4:	aa0a8a93          	addi	s5,s5,-1376 # 9240 <buf>
      if(cc > sizeof(buf))
    ...
    17c2:	a8270713          	addi	a4,a4,-1406 # 9240 <buf>
    ...
    17fa:	eaa50513          	addi	a0,a0,-342 # 56a0 <malloc+0xe32>
    17fe:	00003097          	auipc	ra,0x3
    1802:	fb2080e7          	jalr	-78(ra) # 47b0 <printf>
    exit(1);
    1806:	4505                	li	a0,1
    ...
    1820:	a24b0b13          	addi	s6,s6,-1500 # 9240 <buf>
    ...
    1834:	42da8a93          	addi	s5,s5,1069 # 142d <unlinkread+0x1b3>
{
    ...
    1880:	e3c50513          	addi	a0,a0,-452 # 56b8 <malloc+0xe4a>
    1884:	00003097          	auipc	ra,0x3
    1888:	f2c080e7          	jalr	-212(ra) # 47b0 <printf>
        exit(1);
    188c:	4505                	li	a0,1
    ...
    189c:	e3850513          	addi	a0,a0,-456 # 56d0 <malloc+0xe62>
    18a0:	00003097          	auipc	ra,0x3
    18a4:	f10080e7          	jalr	-240(ra) # 47b0 <printf>
}
    ...
    18ce:	e1e50513          	addi	a0,a0,-482 # 56e8 <malloc+0xe7a>
    18d2:	00003097          	auipc	ra,0x3
    18d6:	ede080e7          	jalr	-290(ra) # 47b0 <printf>
      exit(1);
    18da:	4505                	li	a0,1
    ...
    190e:	dfe50513          	addi	a0,a0,-514 # 5708 <malloc+0xe9a>
    1912:	00003097          	auipc	ra,0x3
    1916:	e9e080e7          	jalr	-354(ra) # 47b0 <printf>
    exit(1);
    191a:	4505                	li	a0,1
...
0000000000001924 <pgbug>:
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1936:	0de4b483          	ld	s1,222(s1) # 6a10 <__SDATA_BEGIN__>
...
000000000000195c <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    1984:	45850513          	addi	a0,a0,1112 # 4dd8 <malloc+0x56a>
    1988:	00003097          	auipc	ra,0x3
    198c:	e28080e7          	jalr	-472(ra) # 47b0 <printf>
    exit(1);
    1990:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    19b2:	3c250513          	addi	a0,a0,962 # 4d70 <malloc+0x502>
    19b6:	00003097          	auipc	ra,0x3
    19ba:	dfa080e7          	jalr	-518(ra) # 47b0 <printf>
    exit(1);
    19be:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    19f6:	d2e58593          	addi	a1,a1,-722 # 5720 <malloc+0xeb2>
    ...
    1a20:	35450513          	addi	a0,a0,852 # 4d70 <malloc+0x502>
    1a24:	00003097          	auipc	ra,0x3
    1a28:	d8c080e7          	jalr	-628(ra) # 47b0 <printf>
     exit(1);
    1a2c:	4505                	li	a0,1
    ...
    1a3a:	cf250513          	addi	a0,a0,-782 # 5728 <malloc+0xeba>
    1a3e:	00003097          	auipc	ra,0x3
    1a42:	d72080e7          	jalr	-654(ra) # 47b0 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    1a5a:	7ea58593          	addi	a1,a1,2026 # 9240 <buf>
    ...
    1a74:	cd050513          	addi	a0,a0,-816 # 5740 <malloc+0xed2>
    1a78:	00003097          	auipc	ra,0x3
    1a7c:	d38080e7          	jalr	-712(ra) # 47b0 <printf>
}
  ...
  printf("kill... ");
    ...
    1aa0:	cbc50513          	addi	a0,a0,-836 # 5758 <malloc+0xeea>
    1aa4:	00003097          	auipc	ra,0x3
    1aa8:	d0c080e7          	jalr	-756(ra) # 47b0 <printf>
  kill(pid1);
    1aac:	854e                	mv	a0,s3
  ...
  printf("wait... ");
    ...
    1ace:	c9e50513          	addi	a0,a0,-866 # 5768 <malloc+0xefa>
    1ad2:	00003097          	auipc	ra,0x3
    1ad6:	cde080e7          	jalr	-802(ra) # 47b0 <printf>
  wait(0);
    1ada:	4501                	li	a0,0
...
0000000000001afa <reparent>:
{
  ...
  exit(0);
    ...
    1b4e:	22650513          	addi	a0,a0,550 # 4d70 <malloc+0x502>
    1b52:	00003097          	auipc	ra,0x3
    1b56:	c5e080e7          	jalr	-930(ra) # 47b0 <printf>
      exit(1);
    1b5a:	4505                	li	a0,1
    ...
    1b6a:	23a50513          	addi	a0,a0,570 # 4da0 <malloc+0x532>
    1b6e:	00003097          	auipc	ra,0x3
    1b72:	c42080e7          	jalr	-958(ra) # 47b0 <printf>
        exit(1);
    1b76:	4505                	li	a0,1
...
0000000000001baa <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    1bd2:	ca0080e7          	jalr	-864(ra) # 486e <malloc>
    ...
    1c12:	b6a50513          	addi	a0,a0,-1174 # 5778 <malloc+0xf0a>
    1c16:	00003097          	auipc	ra,0x3
    1c1a:	b9a080e7          	jalr	-1126(ra) # 47b0 <printf>
      exit(1);
    1c1e:	4505                	li	a0,1
...
0000000000001c40 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    1cd6:	ac650513          	addi	a0,a0,-1338 # 5798 <malloc+0xf2a>
    1cda:	00003097          	auipc	ra,0x3
    1cde:	ad6080e7          	jalr	-1322(ra) # 47b0 <printf>
    exit(1);
    1ce2:	4505                	li	a0,1
    ...
    1cf2:	ad250513          	addi	a0,a0,-1326 # 57c0 <malloc+0xf52>
    1cf6:	00003097          	auipc	ra,0x3
    1cfa:	aba080e7          	jalr	-1350(ra) # 47b0 <printf>
      exit(1);
    1cfe:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    1d36:	d2e50513          	addi	a0,a0,-722 # 4a60 <malloc+0x1f2>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    1d76:	a6e50513          	addi	a0,a0,-1426 # 57e0 <malloc+0xf72>
    1d7a:	00003097          	auipc	ra,0x3
    1d7e:	a36080e7          	jalr	-1482(ra) # 47b0 <printf>
    exit(1);
    1d82:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    1db2:	cb250513          	addi	a0,a0,-846 # 4a60 <malloc+0x1f2>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    1dd8:	a3450513          	addi	a0,a0,-1484 # 5808 <malloc+0xf9a>
    1ddc:	00003097          	auipc	ra,0x3
    1de0:	9d4080e7          	jalr	-1580(ra) # 47b0 <printf>
    exit(1);
    1de4:	4505                	li	a0,1
...
0000000000001df8 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    1e1c:	b4078793          	addi	a5,a5,-1216 # 4958 <malloc+0xea>
    1e20:	f6f43823          	sd	a5,-144(s0)
    1e24:	00003797          	auipc	a5,0x3
    1e28:	b3c78793          	addi	a5,a5,-1220 # 4960 <malloc+0xf2>
    1e2c:	f6f43c23          	sd	a5,-136(s0)
    1e30:	00003797          	auipc	a5,0x3
    1e34:	b3878793          	addi	a5,a5,-1224 # 4968 <malloc+0xfa>
    1e38:	f8f43023          	sd	a5,-128(s0)
    1e3c:	00003797          	auipc	a5,0x3
    1e40:	b3478793          	addi	a5,a5,-1228 # 4970 <malloc+0x102>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1e9a:	3aaa0a13          	addi	s4,s4,938 # 9240 <buf>
    1e9e:	00007a97          	auipc	s5,0x7
    1ea2:	3a3a8a93          	addi	s5,s5,931 # 9241 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    1eb8:	7bc50513          	addi	a0,a0,1980 # 5670 <malloc+0xe02>
    1ebc:	00003097          	auipc	ra,0x3
    1ec0:	8f4080e7          	jalr	-1804(ra) # 47b0 <printf>
      exit(1);
    1ec4:	4505                	li	a0,1
    ...
    1f32:	8f250513          	addi	a0,a0,-1806 # 5820 <malloc+0xfb2>
    1f36:	00003097          	auipc	ra,0x3
    1f3a:	87a080e7          	jalr	-1926(ra) # 47b0 <printf>
        exit(1);
    1f3e:	4505                	li	a0,1
    ...
    1f4c:	8e850513          	addi	a0,a0,-1816 # 5830 <malloc+0xfc2>
    1f50:	00003097          	auipc	ra,0x3
    1f54:	860080e7          	jalr	-1952(ra) # 47b0 <printf>
          exit(1);
    1f58:	4505                	li	a0,1
    ...
    1f70:	8dc50513          	addi	a0,a0,-1828 # 5848 <malloc+0xfda>
    1f74:	00003097          	auipc	ra,0x3
    1f78:	83c080e7          	jalr	-1988(ra) # 47b0 <printf>
          exit(1);
    1f7c:	4505                	li	a0,1
    ...
    1fa0:	2a478793          	addi	a5,a5,676 # 9240 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    2000:	85c50513          	addi	a0,a0,-1956 # 5858 <malloc+0xfea>
    2004:	00002097          	auipc	ra,0x2
    2008:	7ac080e7          	jalr	1964(ra) # 47b0 <printf>
      exit(1);
    200c:	4505                	li	a0,1
...
0000000000002034 <bigfile>:
{
  ...
  unlink("bigfile.test");
    ...
    204c:	82850513          	addi	a0,a0,-2008 # 5870 <malloc+0x1002>
  ...
  fd = open("bigfile.test", O_CREATE | O_RDWR);
    ...
    2060:	81450513          	addi	a0,a0,-2028 # 5870 <malloc+0x1002>
  ...
  for(i = 0; i < N; i++){
    ...
    2074:	1d090913          	addi	s2,s2,464 # 9240 <buf>
  for(i = 0; i < N; i++){
    2078:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.test", 0);
    ...
    20bc:	7b850513          	addi	a0,a0,1976 # 5870 <malloc+0x1002>
  ...
  for(i = 0; ; i++){
    ...
    20d2:	17290913          	addi	s2,s2,370 # 9240 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    2120:	76450513          	addi	a0,a0,1892 # 5880 <malloc+0x1012>
    2124:	00002097          	auipc	ra,0x2
    2128:	68c080e7          	jalr	1676(ra) # 47b0 <printf>
    exit(1);
    212c:	4505                	li	a0,1
    ...
    213c:	76850513          	addi	a0,a0,1896 # 58a0 <malloc+0x1032>
    2140:	00002097          	auipc	ra,0x2
    2144:	670080e7          	jalr	1648(ra) # 47b0 <printf>
      exit(1);
    2148:	4505                	li	a0,1
    ...
    2158:	76c50513          	addi	a0,a0,1900 # 58c0 <malloc+0x1052>
    215c:	00002097          	auipc	ra,0x2
    2160:	654080e7          	jalr	1620(ra) # 47b0 <printf>
    exit(1);
    2164:	4505                	li	a0,1
    ...
    2174:	77050513          	addi	a0,a0,1904 # 58e0 <malloc+0x1072>
    2178:	00002097          	auipc	ra,0x2
    217c:	638080e7          	jalr	1592(ra) # 47b0 <printf>
      exit(1);
    2180:	4505                	li	a0,1
    ...
    2190:	77450513          	addi	a0,a0,1908 # 5900 <malloc+0x1092>
    2194:	00002097          	auipc	ra,0x2
    2198:	61c080e7          	jalr	1564(ra) # 47b0 <printf>
      exit(1);
    219c:	4505                	li	a0,1
    ...
    21ac:	77050513          	addi	a0,a0,1904 # 5918 <malloc+0x10aa>
    21b0:	00002097          	auipc	ra,0x2
    21b4:	600080e7          	jalr	1536(ra) # 47b0 <printf>
      exit(1);
    21b8:	4505                	li	a0,1
  ...
  unlink("bigfile.test");
    ...
    21da:	69a50513          	addi	a0,a0,1690 # 5870 <malloc+0x1002>
    ...
    21fe:	73e50513          	addi	a0,a0,1854 # 5938 <malloc+0x10ca>
    2202:	00002097          	auipc	ra,0x2
    2206:	5ae080e7          	jalr	1454(ra) # 47b0 <printf>
    exit(1);
    220a:	4505                	li	a0,1
...
0000000000002214 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
    ...
    2262:	1e258593          	addi	a1,a1,482 # 5440 <malloc+0xbd2>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    2282:	6e258593          	addi	a1,a1,1762 # 5960 <malloc+0x10f2>
    2286:	00003517          	auipc	a0,0x3
    228a:	6d250513          	addi	a0,a0,1746 # 5958 <malloc+0x10ea>
  ...
  unlink("lf1");
    ...
    229e:	6be50513          	addi	a0,a0,1726 # 5958 <malloc+0x10ea>
    22a2:	00002097          	auipc	ra,0x2
    22a6:	1d6080e7          	jalr	470(ra) # 4478 <unlink>
  if(open("lf1", 0) >= 0){
    22aa:	4581                	li	a1,0
    22ac:	00003517          	auipc	a0,0x3
    22b0:	6ac50513          	addi	a0,a0,1708 # 5958 <malloc+0x10ea>
  ...
  fd = open("lf2", 0);
    ...
    22c6:	69e50513          	addi	a0,a0,1694 # 5960 <malloc+0x10f2>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    22de:	f6658593          	addi	a1,a1,-154 # 9240 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    22fe:	66658593          	addi	a1,a1,1638 # 5960 <malloc+0x10f2>
    2302:	852e                	mv	a0,a1
  ...
  unlink("lf2");
    ...
    2314:	65050513          	addi	a0,a0,1616 # 5960 <malloc+0x10f2>
    2318:	00002097          	auipc	ra,0x2
    231c:	160080e7          	jalr	352(ra) # 4478 <unlink>
  if(link("lf2", "lf1") >= 0){
    2320:	00003597          	auipc	a1,0x3
    2324:	63858593          	addi	a1,a1,1592 # 5958 <malloc+0x10ea>
    2328:	00003517          	auipc	a0,0x3
    232c:	63850513          	addi	a0,a0,1592 # 5960 <malloc+0x10f2>
  ...
  if(link(".", "lf1") >= 0){
    ...
    2340:	61c58593          	addi	a1,a1,1564 # 5958 <malloc+0x10ea>
    2344:	00003517          	auipc	a0,0x3
    2348:	97c50513          	addi	a0,a0,-1668 # 4cc0 <malloc+0x452>
    ...
    236a:	60250513          	addi	a0,a0,1538 # 5968 <malloc+0x10fa>
    236e:	00002097          	auipc	ra,0x2
    2372:	442080e7          	jalr	1090(ra) # 47b0 <printf>
    exit(1);
    2376:	4505                	li	a0,1
    ...
    2386:	5fe50513          	addi	a0,a0,1534 # 5980 <malloc+0x1112>
    238a:	00002097          	auipc	ra,0x2
    238e:	426080e7          	jalr	1062(ra) # 47b0 <printf>
    exit(1);
    2392:	4505                	li	a0,1
    ...
    23a2:	5fa50513          	addi	a0,a0,1530 # 5998 <malloc+0x112a>
    23a6:	00002097          	auipc	ra,0x2
    23aa:	40a080e7          	jalr	1034(ra) # 47b0 <printf>
    exit(1);
    23ae:	4505                	li	a0,1
    ...
    23be:	5fe50513          	addi	a0,a0,1534 # 59b8 <malloc+0x114a>
    23c2:	00002097          	auipc	ra,0x2
    23c6:	3ee080e7          	jalr	1006(ra) # 47b0 <printf>
    exit(1);
    23ca:	4505                	li	a0,1
    ...
    23da:	61250513          	addi	a0,a0,1554 # 59e8 <malloc+0x117a>
    23de:	00002097          	auipc	ra,0x2
    23e2:	3d2080e7          	jalr	978(ra) # 47b0 <printf>
    exit(1);
    23e6:	4505                	li	a0,1
    ...
    23f6:	60e50513          	addi	a0,a0,1550 # 5a00 <malloc+0x1192>
    23fa:	00002097          	auipc	ra,0x2
    23fe:	3b6080e7          	jalr	950(ra) # 47b0 <printf>
    exit(1);
    2402:	4505                	li	a0,1
    ...
    2412:	60a50513          	addi	a0,a0,1546 # 5a18 <malloc+0x11aa>
    2416:	00002097          	auipc	ra,0x2
    241a:	39a080e7          	jalr	922(ra) # 47b0 <printf>
    exit(1);
    241e:	4505                	li	a0,1
    ...
    242e:	61650513          	addi	a0,a0,1558 # 5a40 <malloc+0x11d2>
    2432:	00002097          	auipc	ra,0x2
    2436:	37e080e7          	jalr	894(ra) # 47b0 <printf>
    exit(1);
    243a:	4505                	li	a0,1
    ...
    244a:	62250513          	addi	a0,a0,1570 # 5a68 <malloc+0x11fa>
    244e:	00002097          	auipc	ra,0x2
    2452:	362080e7          	jalr	866(ra) # 47b0 <printf>
    exit(1);
    2456:	4505                	li	a0,1
...
0000000000002460 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    248e:	5feb8b93          	addi	s7,s7,1534 # 5a88 <malloc+0x121a>
  for(i = 0; i < N; i++){
    ...
    24d0:	5c450513          	addi	a0,a0,1476 # 5a90 <malloc+0x1222>
    24d4:	00002097          	auipc	ra,0x2
    24d8:	2dc080e7          	jalr	732(ra) # 47b0 <printf>
        exit(1);
    24dc:	4505                	li	a0,1
    ...
    24ee:	59e50513          	addi	a0,a0,1438 # 5a88 <malloc+0x121a>
  ...
  fd = open(".", 0);
    ...
    2526:	79e50513          	addi	a0,a0,1950 # 4cc0 <malloc+0x452>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    254c:	56850513          	addi	a0,a0,1384 # 5ab0 <malloc+0x1242>
    2550:	00002097          	auipc	ra,0x2
    2554:	260080e7          	jalr	608(ra) # 47b0 <printf>
        exit(1);
    2558:	4505                	li	a0,1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    25bc:	51850513          	addi	a0,a0,1304 # 5ad0 <malloc+0x1262>
    25c0:	00002097          	auipc	ra,0x2
    25c4:	1f0080e7          	jalr	496(ra) # 47b0 <printf>
        exit(1);
    25c8:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    25f4:	50850513          	addi	a0,a0,1288 # 5af8 <malloc+0x128a>
    25f8:	00002097          	auipc	ra,0x2
    25fc:	1b8080e7          	jalr	440(ra) # 47b0 <printf>
    exit(1);
    2600:	4505                	li	a0,1
    ...
    2610:	76450513          	addi	a0,a0,1892 # 4d70 <malloc+0x502>
    2614:	00002097          	auipc	ra,0x2
    2618:	19c080e7          	jalr	412(ra) # 47b0 <printf>
      exit(1);
    261c:	4505                	li	a0,1
...
0000000000002776 <linkunlink>:
{
  ...
  unlink("x");
    ...
    2796:	f8e50513          	addi	a0,a0,-114 # 5720 <malloc+0xeb2>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    27d2:	f52a8a93          	addi	s5,s5,-174 # 5720 <malloc+0xeb2>
      link("cat", "x");
    27d6:	00003b97          	auipc	s7,0x3
    27da:	35ab8b93          	addi	s7,s7,858 # 5b30 <malloc+0x12c2>
    27de:	a091                	j	2822 <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    27e0:	85a6                	mv	a1,s1
    27e2:	00002517          	auipc	a0,0x2
    27e6:	58e50513          	addi	a0,a0,1422 # 4d70 <malloc+0x502>
    27ea:	00002097          	auipc	ra,0x2
    27ee:	fc6080e7          	jalr	-58(ra) # 47b0 <printf>
    exit(1);
    27f2:	4505                	li	a0,1
...
0000000000002878 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    28c8:	274a0a13          	addi	s4,s4,628 # 5b38 <malloc+0x12ca>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    291a:	22250513          	addi	a0,a0,546 # 5b38 <malloc+0x12ca>
  ...
  for(i = 0; i < N; i++){
    ...
    298a:	1ba50513          	addi	a0,a0,442 # 5b40 <malloc+0x12d2>
    298e:	00002097          	auipc	ra,0x2
    2992:	e22080e7          	jalr	-478(ra) # 47b0 <printf>
    exit(1);
    2996:	4505                	li	a0,1
    ...
    29a6:	1be50513          	addi	a0,a0,446 # 5b60 <malloc+0x12f2>
    29aa:	00002097          	auipc	ra,0x2
    29ae:	e06080e7          	jalr	-506(ra) # 47b0 <printf>
      exit(1);
    29b2:	4505                	li	a0,1
    ...
    29c2:	1ba50513          	addi	a0,a0,442 # 5b78 <malloc+0x130a>
    29c6:	00002097          	auipc	ra,0x2
    29ca:	dea080e7          	jalr	-534(ra) # 47b0 <printf>
      exit(1);
    29ce:	4505                	li	a0,1
...
00000000000029d8 <subdir>:
{
  ...
  unlink("ff");
    ...
    29ea:	2e250513          	addi	a0,a0,738 # 5cc8 <malloc+0x145a>
    29ee:	00002097          	auipc	ra,0x2
    29f2:	a8a080e7          	jalr	-1398(ra) # 4478 <unlink>
  if(mkdir("dd") != 0){
    29f6:	00003517          	auipc	a0,0x3
    29fa:	1a250513          	addi	a0,a0,418 # 5b98 <malloc+0x132a>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2a12:	1aa50513          	addi	a0,a0,426 # 5bb8 <malloc+0x134a>
  ...
  write(fd, "ff", 2);
    ...
    2a2a:	2a258593          	addi	a1,a1,674 # 5cc8 <malloc+0x145a>
  ...
  if(unlink("dd") >= 0){
    ...
    2a44:	15850513          	addi	a0,a0,344 # 5b98 <malloc+0x132a>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2a58:	1bc50513          	addi	a0,a0,444 # 5c10 <malloc+0x13a2>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2a70:	1cc50513          	addi	a0,a0,460 # 5c38 <malloc+0x13ca>
  ...
  write(fd, "FF", 2);
    ...
    2a88:	1e458593          	addi	a1,a1,484 # 5c68 <malloc+0x13fa>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2aa4:	1d050513          	addi	a0,a0,464 # 5c70 <malloc+0x1402>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2abc:	78858593          	addi	a1,a1,1928 # 9240 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2ad2:	77274703          	lbu	a4,1906(a4) # 9240 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2aec:	1d858593          	addi	a1,a1,472 # 5cc0 <malloc+0x1452>
    2af0:	00003517          	auipc	a0,0x3
    2af4:	14850513          	addi	a0,a0,328 # 5c38 <malloc+0x13ca>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2b08:	13450513          	addi	a0,a0,308 # 5c38 <malloc+0x13ca>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2b1e:	11e50513          	addi	a0,a0,286 # 5c38 <malloc+0x13ca>
  ...
  if(chdir("dd") != 0){
    ...
    2b32:	06a50513          	addi	a0,a0,106 # 5b98 <malloc+0x132a>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    2b46:	21650513          	addi	a0,a0,534 # 5d58 <malloc+0x14ea>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2b5a:	23250513          	addi	a0,a0,562 # 5d88 <malloc+0x151a>
  ...
  if(chdir("./..") != 0){
    ...
    2b6e:	24e50513          	addi	a0,a0,590 # 5db8 <malloc+0x154a>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    2b84:	14050513          	addi	a0,a0,320 # 5cc0 <malloc+0x1452>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2b9c:	6a858593          	addi	a1,a1,1704 # 9240 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2bbe:	07e50513          	addi	a0,a0,126 # 5c38 <malloc+0x13ca>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2bd6:	27650513          	addi	a0,a0,630 # 5e48 <malloc+0x15da>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2bee:	28e50513          	addi	a0,a0,654 # 5e78 <malloc+0x160a>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2c06:	f9650513          	addi	a0,a0,-106 # 5b98 <malloc+0x132a>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2c1c:	f8050513          	addi	a0,a0,-128 # 5b98 <malloc+0x132a>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2c32:	f6a50513          	addi	a0,a0,-150 # 5b98 <malloc+0x132a>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2c46:	2c658593          	addi	a1,a1,710 # 5f08 <malloc+0x169a>
    2c4a:	00003517          	auipc	a0,0x3
    2c4e:	1fe50513          	addi	a0,a0,510 # 5e48 <malloc+0x15da>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2c62:	2aa58593          	addi	a1,a1,682 # 5f08 <malloc+0x169a>
    2c66:	00003517          	auipc	a0,0x3
    2c6a:	21250513          	addi	a0,a0,530 # 5e78 <malloc+0x160a>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2c7e:	04658593          	addi	a1,a1,70 # 5cc0 <malloc+0x1452>
    2c82:	00003517          	auipc	a0,0x3
    2c86:	f3650513          	addi	a0,a0,-202 # 5bb8 <malloc+0x134a>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2c9a:	1b250513          	addi	a0,a0,434 # 5e48 <malloc+0x15da>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2cae:	1ce50513          	addi	a0,a0,462 # 5e78 <malloc+0x160a>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2cc2:	00250513          	addi	a0,a0,2 # 5cc0 <malloc+0x1452>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2cd6:	1a650513          	addi	a0,a0,422 # 5e78 <malloc+0x160a>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2cea:	16250513          	addi	a0,a0,354 # 5e48 <malloc+0x15da>
  ...
  if(chdir("dd/ff") == 0){
    ...
    2cfe:	ebe50513          	addi	a0,a0,-322 # 5bb8 <malloc+0x134a>
  ...
  if(chdir("dd/xx") == 0){
    ...
    2d12:	34a50513          	addi	a0,a0,842 # 6058 <malloc+0x17ea>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    2d26:	f9e50513          	addi	a0,a0,-98 # 5cc0 <malloc+0x1452>
  ...
  if(unlink("dd/ff") != 0){
    ...
    2d3a:	e8250513          	addi	a0,a0,-382 # 5bb8 <malloc+0x134a>
  ...
  if(unlink("dd") == 0){
    ...
    2d4e:	e4e50513          	addi	a0,a0,-434 # 5b98 <malloc+0x132a>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2d62:	36a50513          	addi	a0,a0,874 # 60c8 <malloc+0x185a>
  ...
  if(unlink("dd") < 0){
    ...
    2d76:	e2650513          	addi	a0,a0,-474 # 5b98 <malloc+0x132a>
    ...
    2d98:	e0c50513          	addi	a0,a0,-500 # 5ba0 <malloc+0x1332>
    2d9c:	00002097          	auipc	ra,0x2
    2da0:	a14080e7          	jalr	-1516(ra) # 47b0 <printf>
    exit(1);
    2da4:	4505                	li	a0,1
    ...
    2db4:	e1050513          	addi	a0,a0,-496 # 5bc0 <malloc+0x1352>
    2db8:	00002097          	auipc	ra,0x2
    2dbc:	9f8080e7          	jalr	-1544(ra) # 47b0 <printf>
    exit(1);
    2dc0:	4505                	li	a0,1
    ...
    2dd0:	e1450513          	addi	a0,a0,-492 # 5be0 <malloc+0x1372>
    2dd4:	00002097          	auipc	ra,0x2
    2dd8:	9dc080e7          	jalr	-1572(ra) # 47b0 <printf>
    exit(1);
    2ddc:	4505                	li	a0,1
    ...
    2dec:	e3050513          	addi	a0,a0,-464 # 5c18 <malloc+0x13aa>
    2df0:	00002097          	auipc	ra,0x2
    2df4:	9c0080e7          	jalr	-1600(ra) # 47b0 <printf>
    exit(1);
    2df8:	4505                	li	a0,1
    ...
    2e08:	e4450513          	addi	a0,a0,-444 # 5c48 <malloc+0x13da>
    2e0c:	00002097          	auipc	ra,0x2
    2e10:	9a4080e7          	jalr	-1628(ra) # 47b0 <printf>
    exit(1);
    2e14:	4505                	li	a0,1
    ...
    2e24:	e6050513          	addi	a0,a0,-416 # 5c80 <malloc+0x1412>
    2e28:	00002097          	auipc	ra,0x2
    2e2c:	988080e7          	jalr	-1656(ra) # 47b0 <printf>
    exit(1);
    2e30:	4505                	li	a0,1
    ...
    2e40:	e6450513          	addi	a0,a0,-412 # 5ca0 <malloc+0x1432>
    2e44:	00002097          	auipc	ra,0x2
    2e48:	96c080e7          	jalr	-1684(ra) # 47b0 <printf>
    exit(1);
    2e4c:	4505                	li	a0,1
    ...
    2e5c:	e7850513          	addi	a0,a0,-392 # 5cd0 <malloc+0x1462>
    2e60:	00002097          	auipc	ra,0x2
    2e64:	950080e7          	jalr	-1712(ra) # 47b0 <printf>
    exit(1);
    2e68:	4505                	li	a0,1
    ...
    2e78:	e8450513          	addi	a0,a0,-380 # 5cf8 <malloc+0x148a>
    2e7c:	00002097          	auipc	ra,0x2
    2e80:	934080e7          	jalr	-1740(ra) # 47b0 <printf>
    exit(1);
    2e84:	4505                	li	a0,1
    ...
    2e94:	e8850513          	addi	a0,a0,-376 # 5d18 <malloc+0x14aa>
    2e98:	00002097          	auipc	ra,0x2
    2e9c:	918080e7          	jalr	-1768(ra) # 47b0 <printf>
    exit(1);
    2ea0:	4505                	li	a0,1
    ...
    2eb0:	e9450513          	addi	a0,a0,-364 # 5d40 <malloc+0x14d2>
    2eb4:	00002097          	auipc	ra,0x2
    2eb8:	8fc080e7          	jalr	-1796(ra) # 47b0 <printf>
    exit(1);
    2ebc:	4505                	li	a0,1
    ...
    2ecc:	ea050513          	addi	a0,a0,-352 # 5d68 <malloc+0x14fa>
    2ed0:	00002097          	auipc	ra,0x2
    2ed4:	8e0080e7          	jalr	-1824(ra) # 47b0 <printf>
    exit(1);
    2ed8:	4505                	li	a0,1
    ...
    2ee8:	eb450513          	addi	a0,a0,-332 # 5d98 <malloc+0x152a>
    2eec:	00002097          	auipc	ra,0x2
    2ef0:	8c4080e7          	jalr	-1852(ra) # 47b0 <printf>
    exit(1);
    2ef4:	4505                	li	a0,1
    ...
    2f04:	ec050513          	addi	a0,a0,-320 # 5dc0 <malloc+0x1552>
    2f08:	00002097          	auipc	ra,0x2
    2f0c:	8a8080e7          	jalr	-1880(ra) # 47b0 <printf>
    exit(1);
    2f10:	4505                	li	a0,1
    ...
    2f20:	ebc50513          	addi	a0,a0,-324 # 5dd8 <malloc+0x156a>
    2f24:	00002097          	auipc	ra,0x2
    2f28:	88c080e7          	jalr	-1908(ra) # 47b0 <printf>
    exit(1);
    2f2c:	4505                	li	a0,1
    ...
    2f3c:	ec050513          	addi	a0,a0,-320 # 5df8 <malloc+0x158a>
    2f40:	00002097          	auipc	ra,0x2
    2f44:	870080e7          	jalr	-1936(ra) # 47b0 <printf>
    exit(1);
    2f48:	4505                	li	a0,1
    ...
    2f58:	ec450513          	addi	a0,a0,-316 # 5e18 <malloc+0x15aa>
    2f5c:	00002097          	auipc	ra,0x2
    2f60:	854080e7          	jalr	-1964(ra) # 47b0 <printf>
    exit(1);
    2f64:	4505                	li	a0,1
    ...
    2f74:	ee850513          	addi	a0,a0,-280 # 5e58 <malloc+0x15ea>
    2f78:	00002097          	auipc	ra,0x2
    2f7c:	838080e7          	jalr	-1992(ra) # 47b0 <printf>
    exit(1);
    2f80:	4505                	li	a0,1
    ...
    2f90:	efc50513          	addi	a0,a0,-260 # 5e88 <malloc+0x161a>
    2f94:	00002097          	auipc	ra,0x2
    2f98:	81c080e7          	jalr	-2020(ra) # 47b0 <printf>
    exit(1);
    2f9c:	4505                	li	a0,1
    ...
    2fac:	f0050513          	addi	a0,a0,-256 # 5ea8 <malloc+0x163a>
    2fb0:	00002097          	auipc	ra,0x2
    2fb4:	800080e7          	jalr	-2048(ra) # 47b0 <printf>
    exit(1);
    2fb8:	4505                	li	a0,1
    ...
    2fc8:	f0450513          	addi	a0,a0,-252 # 5ec8 <malloc+0x165a>
    2fcc:	00001097          	auipc	ra,0x1
    2fd0:	7e4080e7          	jalr	2020(ra) # 47b0 <printf>
    exit(1);
    2fd4:	4505                	li	a0,1
    ...
    2fe4:	f0850513          	addi	a0,a0,-248 # 5ee8 <malloc+0x167a>
    2fe8:	00001097          	auipc	ra,0x1
    2fec:	7c8080e7          	jalr	1992(ra) # 47b0 <printf>
    exit(1);
    2ff0:	4505                	li	a0,1
    ...
    3000:	f1c50513          	addi	a0,a0,-228 # 5f18 <malloc+0x16aa>
    3004:	00001097          	auipc	ra,0x1
    3008:	7ac080e7          	jalr	1964(ra) # 47b0 <printf>
    exit(1);
    300c:	4505                	li	a0,1
    ...
    301c:	f2850513          	addi	a0,a0,-216 # 5f40 <malloc+0x16d2>
    3020:	00001097          	auipc	ra,0x1
    3024:	790080e7          	jalr	1936(ra) # 47b0 <printf>
    exit(1);
    3028:	4505                	li	a0,1
    ...
    3038:	f3450513          	addi	a0,a0,-204 # 5f68 <malloc+0x16fa>
    303c:	00001097          	auipc	ra,0x1
    3040:	774080e7          	jalr	1908(ra) # 47b0 <printf>
    exit(1);
    3044:	4505                	li	a0,1
    ...
    3054:	f4050513          	addi	a0,a0,-192 # 5f90 <malloc+0x1722>
    3058:	00001097          	auipc	ra,0x1
    305c:	758080e7          	jalr	1880(ra) # 47b0 <printf>
    exit(1);
    3060:	4505                	li	a0,1
    ...
    3070:	f4450513          	addi	a0,a0,-188 # 5fb0 <malloc+0x1742>
    3074:	00001097          	auipc	ra,0x1
    3078:	73c080e7          	jalr	1852(ra) # 47b0 <printf>
    exit(1);
    307c:	4505                	li	a0,1
    ...
    308c:	f4850513          	addi	a0,a0,-184 # 5fd0 <malloc+0x1762>
    3090:	00001097          	auipc	ra,0x1
    3094:	720080e7          	jalr	1824(ra) # 47b0 <printf>
    exit(1);
    3098:	4505                	li	a0,1
    ...
    30a8:	f5450513          	addi	a0,a0,-172 # 5ff8 <malloc+0x178a>
    30ac:	00001097          	auipc	ra,0x1
    30b0:	704080e7          	jalr	1796(ra) # 47b0 <printf>
    exit(1);
    30b4:	4505                	li	a0,1
    ...
    30c4:	f5850513          	addi	a0,a0,-168 # 6018 <malloc+0x17aa>
    30c8:	00001097          	auipc	ra,0x1
    30cc:	6e8080e7          	jalr	1768(ra) # 47b0 <printf>
    exit(1);
    30d0:	4505                	li	a0,1
    ...
    30e0:	f5c50513          	addi	a0,a0,-164 # 6038 <malloc+0x17ca>
    30e4:	00001097          	auipc	ra,0x1
    30e8:	6cc080e7          	jalr	1740(ra) # 47b0 <printf>
    exit(1);
    30ec:	4505                	li	a0,1
    ...
    30fc:	f6850513          	addi	a0,a0,-152 # 6060 <malloc+0x17f2>
    3100:	00001097          	auipc	ra,0x1
    3104:	6b0080e7          	jalr	1712(ra) # 47b0 <printf>
    exit(1);
    3108:	4505                	li	a0,1
    ...
    3118:	be450513          	addi	a0,a0,-1052 # 5cf8 <malloc+0x148a>
    311c:	00001097          	auipc	ra,0x1
    3120:	694080e7          	jalr	1684(ra) # 47b0 <printf>
    exit(1);
    3124:	4505                	li	a0,1
    ...
    3134:	f5050513          	addi	a0,a0,-176 # 6080 <malloc+0x1812>
    3138:	00001097          	auipc	ra,0x1
    313c:	678080e7          	jalr	1656(ra) # 47b0 <printf>
    exit(1);
    3140:	4505                	li	a0,1
    ...
    3150:	f5450513          	addi	a0,a0,-172 # 60a0 <malloc+0x1832>
    3154:	00001097          	auipc	ra,0x1
    3158:	65c080e7          	jalr	1628(ra) # 47b0 <printf>
    exit(1);
    315c:	4505                	li	a0,1
    ...
    316c:	f6850513          	addi	a0,a0,-152 # 60d0 <malloc+0x1862>
    3170:	00001097          	auipc	ra,0x1
    3174:	640080e7          	jalr	1600(ra) # 47b0 <printf>
    exit(1);
    3178:	4505                	li	a0,1
    ...
    3188:	f6c50513          	addi	a0,a0,-148 # 60f0 <malloc+0x1882>
    318c:	00001097          	auipc	ra,0x1
    3190:	624080e7          	jalr	1572(ra) # 47b0 <printf>
    exit(1);
    3194:	4505                	li	a0,1
...
000000000000319e <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    31b4:	a0850513          	addi	a0,a0,-1528 # 4bb8 <malloc+0x34a>
  ...
  if(chdir("dirfile") == 0){
    ...
    31d0:	9ec50513          	addi	a0,a0,-1556 # 4bb8 <malloc+0x34a>
  ...
  fd = open("dirfile/xx", 0);
    ...
    31e4:	f6850513          	addi	a0,a0,-152 # 6148 <malloc+0x18da>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    31fc:	f5050513          	addi	a0,a0,-176 # 6148 <malloc+0x18da>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3210:	f3c50513          	addi	a0,a0,-196 # 6148 <malloc+0x18da>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3224:	f2850513          	addi	a0,a0,-216 # 6148 <malloc+0x18da>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3238:	f1458593          	addi	a1,a1,-236 # 6148 <malloc+0x18da>
    323c:	00003517          	auipc	a0,0x3
    3240:	f9450513          	addi	a0,a0,-108 # 61d0 <malloc+0x1962>
  ...
  if(unlink("dirfile") != 0){
    ...
    3254:	96850513          	addi	a0,a0,-1688 # 4bb8 <malloc+0x34a>
  ...
  fd = open(".", O_RDWR);
    ...
    326a:	a5a50513          	addi	a0,a0,-1446 # 4cc0 <malloc+0x452>
  ...
  fd = open(".", 0);
    ...
    3280:	a4450513          	addi	a0,a0,-1468 # 4cc0 <malloc+0x452>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3294:	49058593          	addi	a1,a1,1168 # 5720 <malloc+0xeb2>
  ...
  close(fd);
    ...
    32c0:	e4c50513          	addi	a0,a0,-436 # 6108 <malloc+0x189a>
    32c4:	00001097          	auipc	ra,0x1
    32c8:	4ec080e7          	jalr	1260(ra) # 47b0 <printf>
    exit(1);
    32cc:	4505                	li	a0,1
    ...
    32dc:	e5050513          	addi	a0,a0,-432 # 6128 <malloc+0x18ba>
    32e0:	00001097          	auipc	ra,0x1
    32e4:	4d0080e7          	jalr	1232(ra) # 47b0 <printf>
    exit(1);
    32e8:	4505                	li	a0,1
    ...
    32f8:	e6450513          	addi	a0,a0,-412 # 6158 <malloc+0x18ea>
    32fc:	00001097          	auipc	ra,0x1
    3300:	4b4080e7          	jalr	1204(ra) # 47b0 <printf>
    exit(1);
    3304:	4505                	li	a0,1
    ...
    3314:	e4850513          	addi	a0,a0,-440 # 6158 <malloc+0x18ea>
    3318:	00001097          	auipc	ra,0x1
    331c:	498080e7          	jalr	1176(ra) # 47b0 <printf>
    exit(1);
    3320:	4505                	li	a0,1
    ...
    3330:	e5450513          	addi	a0,a0,-428 # 6180 <malloc+0x1912>
    3334:	00001097          	auipc	ra,0x1
    3338:	47c080e7          	jalr	1148(ra) # 47b0 <printf>
    exit(1);
    333c:	4505                	li	a0,1
    ...
    334c:	e6050513          	addi	a0,a0,-416 # 61a8 <malloc+0x193a>
    3350:	00001097          	auipc	ra,0x1
    3354:	460080e7          	jalr	1120(ra) # 47b0 <printf>
    exit(1);
    3358:	4505                	li	a0,1
    ...
    3368:	e7450513          	addi	a0,a0,-396 # 61d8 <malloc+0x196a>
    336c:	00001097          	auipc	ra,0x1
    3370:	444080e7          	jalr	1092(ra) # 47b0 <printf>
    exit(1);
    3374:	4505                	li	a0,1
    ...
    3384:	e8050513          	addi	a0,a0,-384 # 6200 <malloc+0x1992>
    3388:	00001097          	auipc	ra,0x1
    338c:	428080e7          	jalr	1064(ra) # 47b0 <printf>
    exit(1);
    3390:	4505                	li	a0,1
    ...
    33a0:	e8450513          	addi	a0,a0,-380 # 6220 <malloc+0x19b2>
    33a4:	00001097          	auipc	ra,0x1
    33a8:	40c080e7          	jalr	1036(ra) # 47b0 <printf>
    exit(1);
    33ac:	4505                	li	a0,1
    ...
    33bc:	e9050513          	addi	a0,a0,-368 # 6248 <malloc+0x19da>
    33c0:	00001097          	auipc	ra,0x1
    33c4:	3f0080e7          	jalr	1008(ra) # 47b0 <printf>
    exit(1);
    33c8:	4505                	li	a0,1
...
00000000000033d2 <iref>:
{
    ...
    33f0:	e74a0a13          	addi	s4,s4,-396 # 6260 <malloc+0x19f2>
    mkdir("");
    33f4:	00003497          	auipc	s1,0x3
    33f8:	a4c48493          	addi	s1,s1,-1460 # 5e40 <malloc+0x15d2>
    link("README", "");
    33fc:	00003a97          	auipc	s5,0x3
    3400:	dd4a8a93          	addi	s5,s5,-556 # 61d0 <malloc+0x1962>
    fd = open("xx", O_CREATE);
    3404:	00003997          	auipc	s3,0x3
    3408:	d4c98993          	addi	s3,s3,-692 # 6150 <malloc+0x18e2>
    340c:	a891                	j	3460 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    340e:	85da                	mv	a1,s6
    3410:	00003517          	auipc	a0,0x3
    3414:	e5850513          	addi	a0,a0,-424 # 6268 <malloc+0x19fa>
    3418:	00001097          	auipc	ra,0x1
    341c:	398080e7          	jalr	920(ra) # 47b0 <printf>
      exit(1);
    3420:	4505                	li	a0,1
    ...
    3430:	e5450513          	addi	a0,a0,-428 # 6280 <malloc+0x1a12>
    3434:	00001097          	auipc	ra,0x1
    3438:	37c080e7          	jalr	892(ra) # 47b0 <printf>
      exit(1);
    343c:	4505                	li	a0,1
  ...
  chdir("/");
    ...
    34c0:	7ac50513          	addi	a0,a0,1964 # 4c68 <malloc+0x3fa>
...
00000000000034e0 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    34fc:	da098993          	addi	s3,s3,-608 # 6298 <malloc+0x1a2a>
    3500:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    3538:	d7450513          	addi	a0,a0,-652 # 62a8 <malloc+0x1a3a>
    353c:	00001097          	auipc	ra,0x1
    3540:	274080e7          	jalr	628(ra) # 47b0 <printf>
      exit(1);
    3544:	4505                	li	a0,1
...
000000000000354e <sbrkbasic>:
{
  ...
  if(a != (char*)0xffffffffffffffffL){
    ...
    3578:	d5450513          	addi	a0,a0,-684 # 62c8 <malloc+0x1a5a>
    357c:	00001097          	auipc	ra,0x1
    3580:	234080e7          	jalr	564(ra) # 47b0 <printf>
    exit(1);
    3584:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    35f2:	d4250513          	addi	a0,a0,-702 # 6330 <malloc+0x1ac2>
    35f6:	00001097          	auipc	ra,0x1
    35fa:	1ba080e7          	jalr	442(ra) # 47b0 <printf>
    exit(1);
    35fe:	4505                	li	a0,1
    ...
    3612:	ce250513          	addi	a0,a0,-798 # 62f0 <malloc+0x1a82>
    3616:	00001097          	auipc	ra,0x1
    361a:	19a080e7          	jalr	410(ra) # 47b0 <printf>
      exit(1);
    361e:	4505                	li	a0,1
    ...
    362e:	ce650513          	addi	a0,a0,-794 # 6310 <malloc+0x1aa2>
    3632:	00001097          	auipc	ra,0x1
    3636:	17e080e7          	jalr	382(ra) # 47b0 <printf>
    exit(1);
    363a:	4505                	li	a0,1
...
000000000000366a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    36ae:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f3daf>
  a = sbrk(0);
    36b2:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    3712:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f3daf>
  ...
  if(c != a){
    ...
    375a:	bfa50513          	addi	a0,a0,-1030 # 6350 <malloc+0x1ae2>
    375e:	00001097          	auipc	ra,0x1
    3762:	052080e7          	jalr	82(ra) # 47b0 <printf>
    exit(1);
    3766:	4505                	li	a0,1
    ...
    3776:	c2650513          	addi	a0,a0,-986 # 6398 <malloc+0x1b2a>
    377a:	00001097          	auipc	ra,0x1
    377e:	036080e7          	jalr	54(ra) # 47b0 <printf>
    exit(1);
    3782:	4505                	li	a0,1
    ...
    3794:	c2850513          	addi	a0,a0,-984 # 63b8 <malloc+0x1b4a>
    3798:	00001097          	auipc	ra,0x1
    379c:	018080e7          	jalr	24(ra) # 47b0 <printf>
    exit(1);
    37a0:	4505                	li	a0,1
    ...
    37b2:	c4a50513          	addi	a0,a0,-950 # 63f8 <malloc+0x1b8a>
    37b6:	00001097          	auipc	ra,0x1
    37ba:	ffa080e7          	jalr	-6(ra) # 47b0 <printf>
    exit(1);
    37be:	4505                	li	a0,1
    ...
    37ce:	c5e50513          	addi	a0,a0,-930 # 6428 <malloc+0x1bba>
    37d2:	00001097          	auipc	ra,0x1
    37d6:	fde080e7          	jalr	-34(ra) # 47b0 <printf>
    exit(1);
    37da:	4505                	li	a0,1
    ...
    37ec:	c7850513          	addi	a0,a0,-904 # 6460 <malloc+0x1bf2>
    37f0:	00001097          	auipc	ra,0x1
    37f4:	fc0080e7          	jalr	-64(ra) # 47b0 <printf>
    exit(1);
    37f8:	4505                	li	a0,1
...
0000000000003802 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3838:	e6c50513          	addi	a0,a0,-404 # 56a0 <malloc+0xe32>
    383c:	00001097          	auipc	ra,0x1
    3840:	f74080e7          	jalr	-140(ra) # 47b0 <printf>
    exit(1);
    3844:	4505                	li	a0,1
    ...
    386e:	eb658593          	addi	a1,a1,-330 # 5720 <malloc+0xeb2>
  ...
  if(xstatus != -1)
    ...
    392c:	b6050513          	addi	a0,a0,-1184 # 6488 <malloc+0x1c1a>
    3930:	00001097          	auipc	ra,0x1
    3934:	e80080e7          	jalr	-384(ra) # 47b0 <printf>
    exit(1);
    3938:	4505                	li	a0,1
    ...
    3948:	42c50513          	addi	a0,a0,1068 # 4d70 <malloc+0x502>
    394c:	00001097          	auipc	ra,0x1
    3950:	e64080e7          	jalr	-412(ra) # 47b0 <printf>
    exit(1);
    3954:	4505                	li	a0,1
    ...
    3992:	b1a50513          	addi	a0,a0,-1254 # 64a8 <malloc+0x1c3a>
    3996:	00001097          	auipc	ra,0x1
    399a:	e1a080e7          	jalr	-486(ra) # 47b0 <printf>
    exit(1);
    399e:	4505                	li	a0,1
...
00000000000039b2 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    39d6:	b0650513          	addi	a0,a0,-1274 # 64d8 <malloc+0x1c6a>
    39da:	00001097          	auipc	ra,0x1
    39de:	a8e080e7          	jalr	-1394(ra) # 4468 <open>
    39e2:	84aa                	mv	s1,a0
  unlink("sbrk");
    39e4:	00003517          	auipc	a0,0x3
    39e8:	af450513          	addi	a0,a0,-1292 # 64d8 <malloc+0x1c6a>
  ...
  if(pipe((int *) a) != 0){
    ...
    3a3c:	aa850513          	addi	a0,a0,-1368 # 64e0 <malloc+0x1c72>
    3a40:	00001097          	auipc	ra,0x1
    3a44:	d70080e7          	jalr	-656(ra) # 47b0 <printf>
    exit(1);
    3a48:	4505                	li	a0,1
    ...
    3a58:	aa450513          	addi	a0,a0,-1372 # 64f8 <malloc+0x1c8a>
    3a5c:	00001097          	auipc	ra,0x1
    3a60:	d54080e7          	jalr	-684(ra) # 47b0 <printf>
    exit(1);
    3a64:	4505                	li	a0,1
    ...
    3a74:	c3050513          	addi	a0,a0,-976 # 56a0 <malloc+0xe32>
    3a78:	00001097          	auipc	ra,0x1
    3a7c:	d38080e7          	jalr	-712(ra) # 47b0 <printf>
    exit(1);
    3a80:	4505                	li	a0,1
...
0000000000003a8a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3a9e:	a7650513          	addi	a0,a0,-1418 # 6510 <malloc+0x1ca2>
  ...
  close(fd);
    ...
    3ae6:	a5e50513          	addi	a0,a0,-1442 # 5540 <malloc+0xcd2>
    3aea:	00001097          	auipc	ra,0x1
    3aee:	cc6080e7          	jalr	-826(ra) # 47b0 <printf>
    exit(1);
    3af2:	4505                	li	a0,1
...
0000000000003afc <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    3b34:	b4050513          	addi	a0,a0,-1216 # 5670 <malloc+0xe02>
    3b38:	00001097          	auipc	ra,0x1
    3b3c:	c78080e7          	jalr	-904(ra) # 47b0 <printf>
    exit(1);
    3b40:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    3b8a:	aea50513          	addi	a0,a0,-1302 # 5670 <malloc+0xe02>
    3b8e:	00001097          	auipc	ra,0x1
    3b92:	c22080e7          	jalr	-990(ra) # 47b0 <printf>
    exit(1);
    3b96:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    3bea:	a8a50513          	addi	a0,a0,-1398 # 5670 <malloc+0xe02>
    3bee:	00001097          	auipc	ra,0x1
    3bf2:	bc2080e7          	jalr	-1086(ra) # 47b0 <printf>
    exit(1);
    3bf6:	4505                	li	a0,1
...
0000000000003c14 <dirtest>:
{
  ...
  printf("mkdir test\n");
    ...
    3c24:	8f850513          	addi	a0,a0,-1800 # 6518 <malloc+0x1caa>
    3c28:	00001097          	auipc	ra,0x1
    3c2c:	b88080e7          	jalr	-1144(ra) # 47b0 <printf>
  if(mkdir("dir0") < 0){
    3c30:	00003517          	auipc	a0,0x3
    3c34:	8f850513          	addi	a0,a0,-1800 # 6528 <malloc+0x1cba>
  ...
  if(chdir("dir0") < 0){
    ...
    3c48:	8e450513          	addi	a0,a0,-1820 # 6528 <malloc+0x1cba>
  ...
  if(chdir("..") < 0){
    ...
    3c5c:	08850513          	addi	a0,a0,136 # 4ce0 <malloc+0x472>
  ...
  if(unlink("dir0") < 0){
    ...
    3c70:	8bc50513          	addi	a0,a0,-1860 # 6528 <malloc+0x1cba>
  ...
  printf("%s: mkdir test ok\n");
    ...
    3c84:	8f850513          	addi	a0,a0,-1800 # 6578 <malloc+0x1d0a>
    3c88:	00001097          	auipc	ra,0x1
    3c8c:	b28080e7          	jalr	-1240(ra) # 47b0 <printf>
}
    ...
    3ca0:	f6450513          	addi	a0,a0,-156 # 4c00 <malloc+0x392>
    3ca4:	00001097          	auipc	ra,0x1
    3ca8:	b0c080e7          	jalr	-1268(ra) # 47b0 <printf>
    exit(1);
    3cac:	4505                	li	a0,1
    ...
    3cbc:	87850513          	addi	a0,a0,-1928 # 6530 <malloc+0x1cc2>
    3cc0:	00001097          	auipc	ra,0x1
    3cc4:	af0080e7          	jalr	-1296(ra) # 47b0 <printf>
    exit(1);
    3cc8:	4505                	li	a0,1
    ...
    3cd8:	87450513          	addi	a0,a0,-1932 # 6548 <malloc+0x1cda>
    3cdc:	00001097          	auipc	ra,0x1
    3ce0:	ad4080e7          	jalr	-1324(ra) # 47b0 <printf>
    exit(1);
    3ce4:	4505                	li	a0,1
    ...
    3cf4:	87050513          	addi	a0,a0,-1936 # 6560 <malloc+0x1cf2>
    3cf8:	00001097          	auipc	ra,0x1
    3cfc:	ab8080e7          	jalr	-1352(ra) # 47b0 <printf>
    exit(1);
    3d00:	4505                	li	a0,1
...
0000000000003d0a <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    3d2c:	86850513          	addi	a0,a0,-1944 # 6590 <malloc+0x1d22>
    3d30:	00001097          	auipc	ra,0x1
    3d34:	a80080e7          	jalr	-1408(ra) # 47b0 <printf>
  for(nfiles = 0; ; nfiles++){
    3d38:	4481                	li	s1,0
    name[0] = 'f';
    ...
    3d4c:	858c8c93          	addi	s9,s9,-1960 # 65a0 <malloc+0x1d32>
    int total = 0;
    3d50:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    3d52:	00005a17          	auipc	s4,0x5
    3d56:	4eea0a13          	addi	s4,s4,1262 # 9240 <buf>
    name[0] = 'f';
    ...
    3da4:	a10080e7          	jalr	-1520(ra) # 47b0 <printf>
    ...
    3dc6:	7ee50513          	addi	a0,a0,2030 # 65b0 <malloc+0x1d42>
    3dca:	00001097          	auipc	ra,0x1
    3dce:	9e6080e7          	jalr	-1562(ra) # 47b0 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    3e3c:	7a850513          	addi	a0,a0,1960 # 65e0 <malloc+0x1d72>
    3e40:	00001097          	auipc	ra,0x1
    3e44:	970080e7          	jalr	-1680(ra) # 47b0 <printf>
}
    ...
    3e8c:	74050513          	addi	a0,a0,1856 # 65c8 <malloc+0x1d5a>
    3e90:	00001097          	auipc	ra,0x1
    3e94:	920080e7          	jalr	-1760(ra) # 47b0 <printf>
    close(fd);
    3e98:	854a                	mv	a0,s2
...
0000000000003eaa <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    3eb4:	b6870713          	addi	a4,a4,-1176 # 6a18 <randstate>
    3eb8:	6308                	ld	a0,0(a4)
    3eba:	001967b7          	lui	a5,0x196
    3ebe:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x18a3bd>
    3ec2:	02f50533          	mul	a0,a0,a5
    3ec6:	3c6ef7b7          	lui	a5,0x3c6ef
    3eca:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e310f>
...
0000000000003eda <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    3f4e:	6ae50513          	addi	a0,a0,1710 # 65f8 <malloc+0x1d8a>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    3f66:	7be58593          	addi	a1,a1,1982 # 5720 <malloc+0xeb2>
    ...
    3f7c:	6a050513          	addi	a0,a0,1696 # 6618 <malloc+0x1daa>
    3f80:	00001097          	auipc	ra,0x1
    3f84:	830080e7          	jalr	-2000(ra) # 47b0 <printf>
    exit(1);
    3f88:	4505                	li	a0,1
    ...
    3f96:	66e50513          	addi	a0,a0,1646 # 6600 <malloc+0x1d92>
    3f9a:	00001097          	auipc	ra,0x1
    3f9e:	816080e7          	jalr	-2026(ra) # 47b0 <printf>
      exit(1);
    3fa2:	4505                	li	a0,1
    ...
    3fb0:	65450513          	addi	a0,a0,1620 # 6600 <malloc+0x1d92>
    3fb4:	00000097          	auipc	ra,0x0
    3fb8:	7fc080e7          	jalr	2044(ra) # 47b0 <printf>
    exit(1);
    3fbc:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    3fd4:	62850513          	addi	a0,a0,1576 # 65f8 <malloc+0x1d8a>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    3ffe:	62e50513          	addi	a0,a0,1582 # 6628 <malloc+0x1dba>
    4002:	00000097          	auipc	ra,0x0
    4006:	7ae080e7          	jalr	1966(ra) # 47b0 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4030:	62450513          	addi	a0,a0,1572 # 6650 <malloc+0x1de2>
    4034:	00000097          	auipc	ra,0x0
    4038:	77c080e7          	jalr	1916(ra) # 47b0 <printf>
    else
      printf("OK\n", s);
    return xstatus == 0;
    ...
    4054:	5e850513          	addi	a0,a0,1512 # 6638 <malloc+0x1dca>
    4058:	00000097          	auipc	ra,0x0
    405c:	758080e7          	jalr	1880(ra) # 47b0 <printf>
    exit(1);
    4060:	4505                	li	a0,1
    ...
    407e:	5de50513          	addi	a0,a0,1502 # 6658 <malloc+0x1dea>
    4082:	00000097          	auipc	ra,0x0
    4086:	72e080e7          	jalr	1838(ra) # 47b0 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    40ba:	64a78793          	addi	a5,a5,1610 # 6700 <malloc+0x1e92>
    40be:	ce040713          	addi	a4,s0,-800
    40c2:	00003817          	auipc	a6,0x3
    40c6:	91e80813          	addi	a6,a6,-1762 # 69e0 <malloc+0x2172>
  ...
  printf("usertests starting\n");
    ...
    40f2:	57250513          	addi	a0,a0,1394 # 6660 <malloc+0x1df2>
    40f6:	00000097          	auipc	ra,0x0
    40fa:	6ba080e7          	jalr	1722(ra) # 47b0 <printf>

  if(open("usertests.ran", 0) >= 0){
    40fe:	4581                	li	a1,0
    4100:	00002517          	auipc	a0,0x2
    4104:	57850513          	addi	a0,a0,1400 # 6678 <malloc+0x1e0a>
    ...
    4118:	57450513          	addi	a0,a0,1396 # 6688 <malloc+0x1e1a>
    411c:	00000097          	auipc	ra,0x0
    4120:	694080e7          	jalr	1684(ra) # 47b0 <printf>
    exit(1);
    4124:	4505                	li	a0,1
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    4136:	54650513          	addi	a0,a0,1350 # 6678 <malloc+0x1e0a>
  ...
  if(!fail)
    ...
    418a:	56250513          	addi	a0,a0,1378 # 66e8 <malloc+0x1e7a>
    418e:	00000097          	auipc	ra,0x0
    4192:	622080e7          	jalr	1570(ra) # 47b0 <printf>
    4196:	a809                	j	41a8 <main+0x11c>
    printf("ALL TESTS PASSED\n");
    4198:	00002517          	auipc	a0,0x2
    419c:	53850513          	addi	a0,a0,1336 # 66d0 <malloc+0x1e62>
    41a0:	00000097          	auipc	ra,0x0
    41a4:	610080e7          	jalr	1552(ra) # 47b0 <printf>
  exit(1);   // not reached.
    41a8:	4505                	li	a0,1
...
putc(int fd, char c)
{
    44d8:	1101                	addi	sp,sp,-32
    44da:	ec06                	sd	ra,24(sp)
    44dc:	e822                	sd	s0,16(sp)
    44de:	1000                	addi	s0,sp,32
    44e0:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    44e4:	4605                	li	a2,1
    44e6:	fef40593          	addi	a1,s0,-17
    44ea:	00000097          	auipc	ra,0x0
    44ee:	f5e080e7          	jalr	-162(ra) # 4448 <write>
}
    44f2:	60e2                	ld	ra,24(sp)
    44f4:	6442                	ld	s0,16(sp)
    44f6:	6105                	addi	sp,sp,32
    44f8:	8082                	ret

00000000000044fa <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    44fa:	7139                	addi	sp,sp,-64
    44fc:	fc06                	sd	ra,56(sp)
    44fe:	f822                	sd	s0,48(sp)
    4500:	f426                	sd	s1,40(sp)
    4502:	f04a                	sd	s2,32(sp)
    4504:	ec4e                	sd	s3,24(sp)
    4506:	0080                	addi	s0,sp,64
    4508:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    450a:	c299                	beqz	a3,4510 <printint+0x16>
    450c:	0805c863          	bltz	a1,459c <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    4510:	2581                	sext.w	a1,a1
  neg = 0;
    4512:	4881                	li	a7,0
    4514:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    451a:	2601                	sext.w	a2,a2
    451c:	00002517          	auipc	a0,0x2
    4520:	4dc50513          	addi	a0,a0,1244 # 69f8 <digits>
    4524:	883a                	mv	a6,a4
    4526:	2705                	addiw	a4,a4,1
    4528:	02c5f7bb          	remuw	a5,a1,a2
    452c:	1782                	slli	a5,a5,0x20
    452e:	9381                	srli	a5,a5,0x20
    4530:	97aa                	add	a5,a5,a0
    4532:	0007c783          	lbu	a5,0(a5)
    4536:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    453a:	0005879b          	sext.w	a5,a1
    453e:	02c5d5bb          	divuw	a1,a1,a2
    4542:	0685                	addi	a3,a3,1
    4544:	fec7f0e3          	bgeu	a5,a2,4524 <printint+0x2a>
  if(neg)
    4548:	00088b63          	beqz	a7,455e <printint+0x64>
    buf[i++] = '-';
    454c:	fd040793          	addi	a5,s0,-48
    4550:	973e                	add	a4,a4,a5
    4552:	02d00793          	li	a5,45
    4556:	fef70823          	sb	a5,-16(a4)
    455a:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    455e:	02e05863          	blez	a4,458e <printint+0x94>
    4562:	fc040793          	addi	a5,s0,-64
    4566:	00e78933          	add	s2,a5,a4
    456a:	fff78993          	addi	s3,a5,-1
    456e:	99ba                	add	s3,s3,a4
    4570:	377d                	addiw	a4,a4,-1
    4572:	1702                	slli	a4,a4,0x20
    4574:	9301                	srli	a4,a4,0x20
    4576:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    457a:	fff94583          	lbu	a1,-1(s2)
    457e:	8526                	mv	a0,s1
    4580:	00000097          	auipc	ra,0x0
    4584:	f58080e7          	jalr	-168(ra) # 44d8 <putc>
  while(--i >= 0)
    4588:	197d                	addi	s2,s2,-1
    458a:	ff3918e3          	bne	s2,s3,457a <printint+0x80>
}
    458e:	70e2                	ld	ra,56(sp)
    4590:	7442                	ld	s0,48(sp)
    4592:	74a2                	ld	s1,40(sp)
    4594:	7902                	ld	s2,32(sp)
    4596:	69e2                	ld	s3,24(sp)
    4598:	6121                	addi	sp,sp,64
    459a:	8082                	ret
    x = -xx;
    459c:	40b005bb          	negw	a1,a1
    neg = 1;
    45a0:	4885                	li	a7,1
    x = -xx;
    45a2:	bf8d                	j	4514 <printint+0x1a>

00000000000045a4 <vprintf>:
}
...
{
    45a4:	7119                	addi	sp,sp,-128
    45a6:	fc86                	sd	ra,120(sp)
    45a8:	f8a2                	sd	s0,112(sp)
    45aa:	f4a6                	sd	s1,104(sp)
    45ac:	f0ca                	sd	s2,96(sp)
    45ae:	ecce                	sd	s3,88(sp)
    45b0:	e8d2                	sd	s4,80(sp)
    45b2:	e4d6                	sd	s5,72(sp)
    45b4:	e0da                	sd	s6,64(sp)
    45b6:	fc5e                	sd	s7,56(sp)
    45b8:	f862                	sd	s8,48(sp)
    45ba:	f466                	sd	s9,40(sp)
    45bc:	f06a                	sd	s10,32(sp)
    45be:	ec6e                	sd	s11,24(sp)
    45c0:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    45c2:	0005c903          	lbu	s2,0(a1)
    45c6:	18090f63          	beqz	s2,4764 <vprintf+0x1c0>
    45ca:	8aaa                	mv	s5,a0
    45cc:	8b32                	mv	s6,a2
    45ce:	00158493          	addi	s1,a1,1
  state = 0;
    45d2:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    45d4:	02500a13          	li	s4,37
      if(c == 'd'){
    45d8:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    45dc:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    45e0:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    45e4:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    45e8:	00002b97          	auipc	s7,0x2
    45ec:	410b8b93          	addi	s7,s7,1040 # 69f8 <digits>
    45f0:	a839                	j	460e <vprintf+0x6a>
        putc(fd, c);
    45f2:	85ca                	mv	a1,s2
    45f4:	8556                	mv	a0,s5
    45f6:	00000097          	auipc	ra,0x0
    45fa:	ee2080e7          	jalr	-286(ra) # 44d8 <putc>
    45fe:	a019                	j	4604 <vprintf+0x60>
    } else if(state == '%'){
    4600:	01498f63          	beq	s3,s4,461e <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    4604:	0485                	addi	s1,s1,1
    4606:	fff4c903          	lbu	s2,-1(s1)
    460a:	14090d63          	beqz	s2,4764 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    460e:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4612:	fe0997e3          	bnez	s3,4600 <vprintf+0x5c>
      if(c == '%'){
    4616:	fd479ee3          	bne	a5,s4,45f2 <vprintf+0x4e>
        state = '%';
    461a:	89be                	mv	s3,a5
    461c:	b7e5                	j	4604 <vprintf+0x60>
      if(c == 'd'){
    461e:	05878063          	beq	a5,s8,465e <vprintf+0xba>
      } else if(c == 'l') {
    4622:	05978c63          	beq	a5,s9,467a <vprintf+0xd6>
      } else if(c == 'x') {
    4626:	07a78863          	beq	a5,s10,4696 <vprintf+0xf2>
      } else if(c == 'p') {
    462a:	09b78463          	beq	a5,s11,46b2 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    462e:	07300713          	li	a4,115
    4632:	0ce78663          	beq	a5,a4,46fe <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    4636:	06300713          	li	a4,99
    463a:	0ee78e63          	beq	a5,a4,4736 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    463e:	11478863          	beq	a5,s4,474e <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    464a:	e92080e7          	jalr	-366(ra) # 44d8 <putc>
        putc(fd, c);
    464e:	85ca                	mv	a1,s2
    4650:	8556                	mv	a0,s5
    4652:	00000097          	auipc	ra,0x0
    4656:	e86080e7          	jalr	-378(ra) # 44d8 <putc>
      }
      state = 0;
    465a:	4981                	li	s3,0
    465c:	b765                	j	4604 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    465e:	008b0913          	addi	s2,s6,8
    4662:	4685                	li	a3,1
    4664:	4629                	li	a2,10
    4666:	000b2583          	lw	a1,0(s6)
    466a:	8556                	mv	a0,s5
    466c:	00000097          	auipc	ra,0x0
    4670:	e8e080e7          	jalr	-370(ra) # 44fa <printint>
    4674:	8b4a                	mv	s6,s2
      state = 0;
    4676:	4981                	li	s3,0
    4678:	b771                	j	4604 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    467a:	008b0913          	addi	s2,s6,8
    467e:	4681                	li	a3,0
    4680:	4629                	li	a2,10
    4682:	000b2583          	lw	a1,0(s6)
    4686:	8556                	mv	a0,s5
    4688:	00000097          	auipc	ra,0x0
    468c:	e72080e7          	jalr	-398(ra) # 44fa <printint>
    4690:	8b4a                	mv	s6,s2
      state = 0;
    4692:	4981                	li	s3,0
    4694:	bf85                	j	4604 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    4696:	008b0913          	addi	s2,s6,8
    469a:	4681                	li	a3,0
    469c:	4641                	li	a2,16
    469e:	000b2583          	lw	a1,0(s6)
    46a2:	8556                	mv	a0,s5
    46a4:	00000097          	auipc	ra,0x0
    46a8:	e56080e7          	jalr	-426(ra) # 44fa <printint>
    46ac:	8b4a                	mv	s6,s2
      state = 0;
    46ae:	4981                	li	s3,0
    46b0:	bf91                	j	4604 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    46b2:	008b0793          	addi	a5,s6,8
    46b6:	f8f43423          	sd	a5,-120(s0)
    46ba:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    46be:	03000593          	li	a1,48
    46c2:	8556                	mv	a0,s5
    46c4:	00000097          	auipc	ra,0x0
    46c8:	e14080e7          	jalr	-492(ra) # 44d8 <putc>
  putc(fd, 'x');
    46cc:	85ea                	mv	a1,s10
    46ce:	8556                	mv	a0,s5
    46d0:	00000097          	auipc	ra,0x0
    46d4:	e08080e7          	jalr	-504(ra) # 44d8 <putc>
    46d8:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    46da:	03c9d793          	srli	a5,s3,0x3c
    46de:	97de                	add	a5,a5,s7
    46e0:	0007c583          	lbu	a1,0(a5)
    46e4:	8556                	mv	a0,s5
    46e6:	00000097          	auipc	ra,0x0
    46ea:	df2080e7          	jalr	-526(ra) # 44d8 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    46ee:	0992                	slli	s3,s3,0x4
    46f0:	397d                	addiw	s2,s2,-1
    46f2:	fe0914e3          	bnez	s2,46da <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    46f6:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    46fa:	4981                	li	s3,0
    46fc:	b721                	j	4604 <vprintf+0x60>
        s = va_arg(ap, char*);
    46fe:	008b0993          	addi	s3,s6,8
    4702:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    4706:	02090163          	beqz	s2,4728 <vprintf+0x184>
        while(*s != 0){
    470a:	00094583          	lbu	a1,0(s2)
    470e:	c9a1                	beqz	a1,475e <vprintf+0x1ba>
          putc(fd, *s);
    4710:	8556                	mv	a0,s5
    4712:	00000097          	auipc	ra,0x0
    4716:	dc6080e7          	jalr	-570(ra) # 44d8 <putc>
          s++;
    471a:	0905                	addi	s2,s2,1
        while(*s != 0){
    471c:	00094583          	lbu	a1,0(s2)
    4720:	f9e5                	bnez	a1,4710 <vprintf+0x16c>
        s = va_arg(ap, char*);
    4722:	8b4e                	mv	s6,s3
      state = 0;
    4724:	4981                	li	s3,0
    4726:	bdf9                	j	4604 <vprintf+0x60>
          s = "(null)";
    4728:	00002917          	auipc	s2,0x2
    472c:	2c890913          	addi	s2,s2,712 # 69f0 <malloc+0x2182>
        while(*s != 0){
    4730:	02800593          	li	a1,40
    4734:	bff1                	j	4710 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    4736:	008b0913          	addi	s2,s6,8
    473a:	000b4583          	lbu	a1,0(s6)
    473e:	8556                	mv	a0,s5
    4740:	00000097          	auipc	ra,0x0
    4744:	d98080e7          	jalr	-616(ra) # 44d8 <putc>
    4748:	8b4a                	mv	s6,s2
      state = 0;
    474a:	4981                	li	s3,0
    474c:	bd65                	j	4604 <vprintf+0x60>
        putc(fd, c);
    474e:	85d2                	mv	a1,s4
    4750:	8556                	mv	a0,s5
    4752:	00000097          	auipc	ra,0x0
    4756:	d86080e7          	jalr	-634(ra) # 44d8 <putc>
      state = 0;
    475a:	4981                	li	s3,0
    475c:	b565                	j	4604 <vprintf+0x60>
        s = va_arg(ap, char*);
    475e:	8b4e                	mv	s6,s3
      state = 0;
    4760:	4981                	li	s3,0
    4762:	b54d                	j	4604 <vprintf+0x60>
    }
  }
}
    4764:	70e6                	ld	ra,120(sp)
    4766:	7446                	ld	s0,112(sp)
    4768:	74a6                	ld	s1,104(sp)
    476a:	7906                	ld	s2,96(sp)
    476c:	69e6                	ld	s3,88(sp)
    476e:	6a46                	ld	s4,80(sp)
    4770:	6aa6                	ld	s5,72(sp)
    4772:	6b06                	ld	s6,64(sp)
    4774:	7be2                	ld	s7,56(sp)
    4776:	7c42                	ld	s8,48(sp)
    4778:	7ca2                	ld	s9,40(sp)
    477a:	7d02                	ld	s10,32(sp)
    477c:	6de2                	ld	s11,24(sp)
    477e:	6109                	addi	sp,sp,128
    4780:	8082                	ret

0000000000004782 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    4782:	715d                	addi	sp,sp,-80
    4784:	ec06                	sd	ra,24(sp)
    4786:	e822                	sd	s0,16(sp)
    4788:	1000                	addi	s0,sp,32
    478a:	e010                	sd	a2,0(s0)
    478c:	e414                	sd	a3,8(s0)
    478e:	e818                	sd	a4,16(s0)
    4790:	ec1c                	sd	a5,24(s0)
    4792:	03043023          	sd	a6,32(s0)
    4796:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    479a:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    479e:	8622                	mv	a2,s0
    47a0:	00000097          	auipc	ra,0x0
    47a4:	e04080e7          	jalr	-508(ra) # 45a4 <vprintf>
}
    47a8:	60e2                	ld	ra,24(sp)
    47aa:	6442                	ld	s0,16(sp)
    47ac:	6161                	addi	sp,sp,80
    47ae:	8082                	ret

00000000000047b0 <printf>:

void
printf(const char *fmt, ...)
{
    47b0:	711d                	addi	sp,sp,-96
    47b2:	ec06                	sd	ra,24(sp)
    47b4:	e822                	sd	s0,16(sp)
    47b6:	1000                	addi	s0,sp,32
    47b8:	e40c                	sd	a1,8(s0)
    47ba:	e810                	sd	a2,16(s0)
    47bc:	ec14                	sd	a3,24(s0)
    47be:	f018                	sd	a4,32(s0)
    47c0:	f41c                	sd	a5,40(s0)
    47c2:	03043823          	sd	a6,48(s0)
    47c6:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    47ca:	00840613          	addi	a2,s0,8
    47ce:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    47d2:	85aa                	mv	a1,a0
    47d4:	4505                	li	a0,1
    47d6:	00000097          	auipc	ra,0x0
    47da:	dce080e7          	jalr	-562(ra) # 45a4 <vprintf>
}
    47de:	60e2                	ld	ra,24(sp)
    47e0:	6442                	ld	s0,16(sp)
    47e2:	6125                	addi	sp,sp,96
    47e4:	8082                	ret

00000000000047e6 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    47e6:	1141                	addi	sp,sp,-16
    47e8:	e422                	sd	s0,8(sp)
    47ea:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    47ec:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    47f0:	00002797          	auipc	a5,0x2
    47f4:	2387b783          	ld	a5,568(a5) # 6a28 <freep>
    47f8:	a805                	j	4828 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    47fa:	4618                	lw	a4,8(a2)
    47fc:	9db9                	addw	a1,a1,a4
    47fe:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    4802:	6398                	ld	a4,0(a5)
    4804:	6318                	ld	a4,0(a4)
    4806:	fee53823          	sd	a4,-16(a0)
    480a:	a091                	j	484e <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    480c:	ff852703          	lw	a4,-8(a0)
    4810:	9e39                	addw	a2,a2,a4
    4812:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    4814:	ff053703          	ld	a4,-16(a0)
    4818:	e398                	sd	a4,0(a5)
    481a:	a099                	j	4860 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    481c:	6398                	ld	a4,0(a5)
    481e:	00e7e463          	bltu	a5,a4,4826 <free+0x40>
    4822:	00e6ea63          	bltu	a3,a4,4836 <free+0x50>
{
    4826:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4828:	fed7fae3          	bgeu	a5,a3,481c <free+0x36>
    482c:	6398                	ld	a4,0(a5)
    482e:	00e6e463          	bltu	a3,a4,4836 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4832:	fee7eae3          	bltu	a5,a4,4826 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    4836:	ff852583          	lw	a1,-8(a0)
    483a:	6390                	ld	a2,0(a5)
    483c:	02059713          	slli	a4,a1,0x20
    4840:	9301                	srli	a4,a4,0x20
    4842:	0712                	slli	a4,a4,0x4
    4844:	9736                	add	a4,a4,a3
    4846:	fae60ae3          	beq	a2,a4,47fa <free+0x14>
    bp->s.ptr = p->s.ptr;
    484a:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    484e:	4790                	lw	a2,8(a5)
    4850:	02061713          	slli	a4,a2,0x20
    4854:	9301                	srli	a4,a4,0x20
    4856:	0712                	slli	a4,a4,0x4
    4858:	973e                	add	a4,a4,a5
    485a:	fae689e3          	beq	a3,a4,480c <free+0x26>
  } else
    p->s.ptr = bp;
    485e:	e394                	sd	a3,0(a5)
  freep = p;
    4860:	00002717          	auipc	a4,0x2
    4864:	1cf73423          	sd	a5,456(a4) # 6a28 <freep>
}
    4868:	6422                	ld	s0,8(sp)
    486a:	0141                	addi	sp,sp,16
    486c:	8082                	ret

000000000000486e <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    ...
    4870:	fc06                	sd	ra,56(sp)
    4872:	f822                	sd	s0,48(sp)
    4874:	f426                	sd	s1,40(sp)
    4876:	f04a                	sd	s2,32(sp)
    4878:	ec4e                	sd	s3,24(sp)
    487a:	e852                	sd	s4,16(sp)
    487c:	e456                	sd	s5,8(sp)
    487e:	e05a                	sd	s6,0(sp)
    4880:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4882:	02051493          	slli	s1,a0,0x20
    4886:	9081                	srli	s1,s1,0x20
    4888:	04bd                	addi	s1,s1,15
    488a:	8091                	srli	s1,s1,0x4
    488c:	0014899b          	addiw	s3,s1,1
    4890:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    4892:	00002517          	auipc	a0,0x2
    4896:	19653503          	ld	a0,406(a0) # 6a28 <freep>
    489a:	c515                	beqz	a0,48c6 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    489c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    489e:	4798                	lw	a4,8(a5)
    48a0:	02977f63          	bgeu	a4,s1,48de <malloc+0x70>
    48a4:	8a4e                	mv	s4,s3
    48a6:	0009871b          	sext.w	a4,s3
    48aa:	6685                	lui	a3,0x1
    48ac:	00d77363          	bgeu	a4,a3,48b2 <malloc+0x44>
    48b0:	6a05                	lui	s4,0x1
    48b2:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    48b6:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    48ba:	00002917          	auipc	s2,0x2
    48be:	16e90913          	addi	s2,s2,366 # 6a28 <freep>
  if(p == (char*)-1)
    48c2:	5afd                	li	s5,-1
    48c4:	a88d                	j	4936 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    48c6:	00008797          	auipc	a5,0x8
    48ca:	97a78793          	addi	a5,a5,-1670 # c240 <base>
    48ce:	00002717          	auipc	a4,0x2
    48d2:	14f73d23          	sd	a5,346(a4) # 6a28 <freep>
    48d6:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    48d8:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    48dc:	b7e1                	j	48a4 <malloc+0x36>
      if(p->s.size == nunits)
    48de:	02e48b63          	beq	s1,a4,4914 <malloc+0xa6>
        p->s.size -= nunits;
    48e2:	4137073b          	subw	a4,a4,s3
    48e6:	c798                	sw	a4,8(a5)
        p += p->s.size;
    48e8:	1702                	slli	a4,a4,0x20
    48ea:	9301                	srli	a4,a4,0x20
    48ec:	0712                	slli	a4,a4,0x4
    48ee:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    48f0:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    48f4:	00002717          	auipc	a4,0x2
    48f8:	12a73a23          	sd	a0,308(a4) # 6a28 <freep>
      return (void*)(p + 1);
    48fc:	01078513          	addi	a0,a5,16
    ...
    490e:	6b02                	ld	s6,0(sp)
    4910:	6121                	addi	sp,sp,64
    4912:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    4914:	6398                	ld	a4,0(a5)
    4916:	e118                	sd	a4,0(a0)
    4918:	bff1                	j	48f4 <malloc+0x86>
  hp->s.size = nu;
    491a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    491e:	0541                	addi	a0,a0,16
    4920:	00000097          	auipc	ra,0x0
    4924:	ec6080e7          	jalr	-314(ra) # 47e6 <free>
  return freep;
    4928:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    492c:	d971                	beqz	a0,4900 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    492e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    4930:	4798                	lw	a4,8(a5)
    4932:	fa9776e3          	bgeu	a4,s1,48de <malloc+0x70>
    if(p == freep)
    4936:	00093703          	ld	a4,0(s2)
    493a:	853e                	mv	a0,a5
    493c:	fef719e3          	bne	a4,a5,492e <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    4940:	8552                	mv	a0,s4
    4942:	00000097          	auipc	ra,0x0
    4946:	b6e080e7          	jalr	-1170(ra) # 44b0 <sbrk>
  if(p == (char*)-1)
    494a:	fd5518e3          	bne	a0,s5,491a <malloc+0xac>
        return 0;
    494e:	4501                	li	a0,0
    4950:	bf45                	j	4900 <malloc+0x92>
